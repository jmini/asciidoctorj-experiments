...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionCustomTestCase} (ruby engine) .
 */
public class ImageCaptionCustomReferenceTest extends AbstractImageCaptionCustomTesting {
