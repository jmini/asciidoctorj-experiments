...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningTestCase} (ruby engine) .
 */
public class AdmonitionParagraphWarningReferenceTest extends AbstractAdmonitionParagraphWarningTesting {
