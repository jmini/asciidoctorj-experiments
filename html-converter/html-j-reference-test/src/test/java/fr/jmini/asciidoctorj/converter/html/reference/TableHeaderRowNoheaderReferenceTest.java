...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowNoheaderTestCase} (ruby engine) .
 */
public class TableHeaderRowNoheaderReferenceTest extends AbstractTableHeaderRowNoheaderTesting {
