...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListOlUpperalphaTestCase} (ruby engine) .
 */
public class ListOlUpperalphaReferenceTest extends AbstractListOlUpperalphaTesting {
