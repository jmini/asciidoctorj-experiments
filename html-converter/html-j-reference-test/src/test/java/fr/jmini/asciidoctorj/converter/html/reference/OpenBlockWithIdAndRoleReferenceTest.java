...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockWithIdAndRoleTestCase} (ruby engine) .
 */
public class OpenBlockWithIdAndRoleReferenceTest extends AbstractOpenBlockWithIdAndRoleTesting {
