...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableCellColspanRowspanTestCase} (ruby engine) .
 */
public class TableCellColspanRowspanReferenceTest extends AbstractTableCellColspanRowspanTesting {
