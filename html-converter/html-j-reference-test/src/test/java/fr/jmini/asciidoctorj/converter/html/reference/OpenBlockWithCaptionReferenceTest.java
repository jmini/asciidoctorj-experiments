...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockWithCaptionTestCase} (ruby engine) .
 */
public class OpenBlockWithCaptionReferenceTest extends AbstractOpenBlockWithCaptionTesting {
