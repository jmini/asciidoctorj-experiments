...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListingParagraphSyntaxTestCase} (ruby engine) .
 */
public class ListingParagraphSyntaxReferenceTest extends AbstractListingParagraphSyntaxTesting {
