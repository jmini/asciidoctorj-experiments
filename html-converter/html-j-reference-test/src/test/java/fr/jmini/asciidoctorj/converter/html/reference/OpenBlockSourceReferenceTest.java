...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockSourceTestCase} (ruby engine) .
 */
public class OpenBlockSourceReferenceTest extends AbstractOpenBlockSourceTesting {
