...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridNoneTestCase} (ruby engine) .
 */
public class TableBorderGridNoneReferenceTest extends AbstractTableBorderGridNoneTesting {
