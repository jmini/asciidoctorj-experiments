...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledTestCase} (ruby engine) .
 */
public class ListLabeledReferenceTest extends AbstractListLabeledTesting {
