...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ImageNormalizeSrcTestCase} (ruby engine) .
 */
public class ImageNormalizeSrcReferenceTest extends AbstractImageNormalizeSrcTesting {
