...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowOnlyTestCase} (ruby engine) .
 */
public class TableHeaderRowOnlyReferenceTest extends AbstractTableHeaderRowOnlyTesting {
