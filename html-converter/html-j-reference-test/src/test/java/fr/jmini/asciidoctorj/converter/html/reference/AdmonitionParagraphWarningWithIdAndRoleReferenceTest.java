...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningWithIdAndRoleTestCase} (ruby engine) .
 */
public class AdmonitionParagraphWarningWithIdAndRoleReferenceTest extends AbstractAdmonitionParagraphWarningWithIdAndRoleTesting {
