...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListOlDecimalTestCase} (ruby engine) .
 */
public class ListOlDecimalReferenceTest extends AbstractListOlDecimalTesting {
