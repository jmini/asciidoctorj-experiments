...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableBorderFrameTopbotTestCase} (ruby engine) .
 */
public class TableBorderFrameTopbotReferenceTest extends AbstractTableBorderFrameTopbotTesting {
