...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.SectionWithLeveloffsetTestCase} (ruby engine) .
 */
public class SectionWithLeveloffsetReferenceTest extends AbstractSectionWithLeveloffsetTesting {
