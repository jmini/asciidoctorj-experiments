...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridRowsTestCase} (ruby engine) .
 */
public class TableBorderGridRowsReferenceTest extends AbstractTableBorderGridRowsTesting {
