...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableAutowidthTestCase} (ruby engine) .
 */
public class TableAutowidthReferenceTest extends AbstractTableAutowidthTesting {
