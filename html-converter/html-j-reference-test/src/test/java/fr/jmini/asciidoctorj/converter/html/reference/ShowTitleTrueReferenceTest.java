...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ShowTitleTrueTestCase} (ruby engine) .
 */
public class ShowTitleTrueReferenceTest extends AbstractShowTitleTrueTesting {
