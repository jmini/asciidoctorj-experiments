...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.NoTitleUnsetTestCase} (ruby engine) .
 */
public class NoTitleUnsetReferenceTest extends AbstractNoTitleUnsetTesting {
