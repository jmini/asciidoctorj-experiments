...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionEmptyTestCase} (ruby engine) .
 */
public class ListingCaptionEmptyReferenceTest extends AbstractListingCaptionEmptyTesting {
