...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphCautionTestCase} (ruby engine) .
 */
public class AdmonitionParagraphCautionReferenceTest extends AbstractAdmonitionParagraphCautionTesting {
