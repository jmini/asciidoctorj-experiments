...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableCellAlignedTestCase} (ruby engine) .
 */
public class TableCellAlignedReferenceTest extends AbstractTableCellAlignedTesting {
