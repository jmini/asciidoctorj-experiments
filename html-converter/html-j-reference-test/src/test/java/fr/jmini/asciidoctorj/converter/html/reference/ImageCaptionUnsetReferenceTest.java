...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionUnsetTestCase} (ruby engine) .
 */
public class ImageCaptionUnsetReferenceTest extends AbstractImageCaptionUnsetTesting {
