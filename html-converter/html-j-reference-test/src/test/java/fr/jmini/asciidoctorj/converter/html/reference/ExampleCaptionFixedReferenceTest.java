...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionFixedTestCase} (ruby engine) .
 */
public class ExampleCaptionFixedReferenceTest extends AbstractExampleCaptionFixedTesting {
