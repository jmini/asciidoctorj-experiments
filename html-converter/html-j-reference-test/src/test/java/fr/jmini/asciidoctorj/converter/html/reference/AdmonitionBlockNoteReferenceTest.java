...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockNoteTestCase} (ruby engine) .
 */
public class AdmonitionBlockNoteReferenceTest extends AbstractAdmonitionBlockNoteTesting {
