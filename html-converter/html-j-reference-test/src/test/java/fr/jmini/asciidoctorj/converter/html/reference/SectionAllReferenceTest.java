...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.SectionAllTestCase} (ruby engine) .
 */
public class SectionAllReferenceTest extends AbstractSectionAllTesting {
