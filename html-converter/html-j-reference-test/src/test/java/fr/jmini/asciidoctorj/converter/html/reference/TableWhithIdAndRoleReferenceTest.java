...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableWhithIdAndRoleTestCase} (ruby engine) .
 */
public class TableWhithIdAndRoleReferenceTest extends AbstractTableWhithIdAndRoleTesting {
