...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.SectionWithSectnumTestCase} (ruby engine) .
 */
public class SectionWithSectnumReferenceTest extends AbstractSectionWithSectnumTesting {
