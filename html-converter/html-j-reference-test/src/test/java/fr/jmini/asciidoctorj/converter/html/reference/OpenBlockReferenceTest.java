...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockTestCase} (ruby engine) .
 */
public class OpenBlockReferenceTest extends AbstractOpenBlockTesting {
