...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListOlLoweralphaTestCase} (ruby engine) .
 */
public class ListOlLoweralphaReferenceTest extends AbstractListOlLoweralphaTesting {
