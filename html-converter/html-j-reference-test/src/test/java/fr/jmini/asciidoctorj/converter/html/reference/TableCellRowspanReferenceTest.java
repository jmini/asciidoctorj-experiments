...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableCellRowspanTestCase} (ruby engine) .
 */
public class TableCellRowspanReferenceTest extends AbstractTableCellRowspanTesting {
