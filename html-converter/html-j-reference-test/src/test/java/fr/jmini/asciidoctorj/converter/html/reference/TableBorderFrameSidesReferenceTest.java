...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableBorderFrameSidesTestCase} (ruby engine) .
 */
public class TableBorderFrameSidesReferenceTest extends AbstractTableBorderFrameSidesTesting {
