...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionCustomCounterTestCase} (ruby engine) .
 */
public class ExampleCaptionCustomCounterReferenceTest extends AbstractExampleCaptionCustomCounterTesting {
