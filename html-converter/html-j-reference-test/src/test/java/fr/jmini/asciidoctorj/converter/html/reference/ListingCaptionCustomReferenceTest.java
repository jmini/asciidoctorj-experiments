...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionCustomTestCase} (ruby engine) .
 */
public class ListingCaptionCustomReferenceTest extends AbstractListingCaptionCustomTesting {
