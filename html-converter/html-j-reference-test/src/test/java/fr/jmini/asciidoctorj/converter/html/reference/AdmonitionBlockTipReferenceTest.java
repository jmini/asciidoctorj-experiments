...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockTipTestCase} (ruby engine) .
 */
public class AdmonitionBlockTipReferenceTest extends AbstractAdmonitionBlockTipTesting {
