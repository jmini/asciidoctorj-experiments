...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockImportantTestCase} (ruby engine) .
 */
public class AdmonitionBlockImportantReferenceTest extends AbstractAdmonitionBlockImportantTesting {
