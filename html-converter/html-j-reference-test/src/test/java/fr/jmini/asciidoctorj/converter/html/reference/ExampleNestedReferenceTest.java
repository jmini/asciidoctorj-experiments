...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ExampleNestedTestCase} (ruby engine) .
 */
public class ExampleNestedReferenceTest extends AbstractExampleNestedTesting {
