...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.HorizontalRuleTestCase} (ruby engine) .
 */
public class HorizontalRuleReferenceTest extends AbstractHorizontalRuleTesting {
