...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridColsTestCase} (ruby engine) .
 */
public class TableBorderGridColsReferenceTest extends AbstractTableBorderGridColsTesting {
