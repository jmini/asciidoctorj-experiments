...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowTestCase} (ruby engine) .
 */
public class TableHeaderRowReferenceTest extends AbstractTableHeaderRowTesting {
