...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledNestedMixedTestCase} (ruby engine) .
 */
public class ListLabeledNestedMixedReferenceTest extends AbstractListLabeledNestedMixedTesting {
