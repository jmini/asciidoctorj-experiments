...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockWarningTestCase} (ruby engine) .
 */
public class AdmonitionBlockWarningReferenceTest extends AbstractAdmonitionBlockWarningTesting {
