...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledWithIdAndRoleTestCase} (ruby engine) .
 */
public class ListLabeledWithIdAndRoleReferenceTest extends AbstractListLabeledWithIdAndRoleTesting {
