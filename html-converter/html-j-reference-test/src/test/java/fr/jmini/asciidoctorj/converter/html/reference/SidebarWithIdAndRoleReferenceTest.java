...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.SidebarWithIdAndRoleTestCase} (ruby engine) .
 */
public class SidebarWithIdAndRoleReferenceTest extends AbstractSidebarWithIdAndRoleTesting {
