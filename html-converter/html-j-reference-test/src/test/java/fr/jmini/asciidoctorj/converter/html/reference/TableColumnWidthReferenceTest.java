...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableColumnWidthTestCase} (ruby engine) .
 */
public class TableColumnWidthReferenceTest extends AbstractTableColumnWidthTesting {
