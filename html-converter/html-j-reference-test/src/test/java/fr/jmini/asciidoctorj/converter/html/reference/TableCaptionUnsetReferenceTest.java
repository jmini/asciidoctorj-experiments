...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionUnsetTestCase} (ruby engine) .
 */
public class TableCaptionUnsetReferenceTest extends AbstractTableCaptionUnsetTesting {
