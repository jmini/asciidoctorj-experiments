...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionFixedTestCase} (ruby engine) .
 */
public class ImageCaptionFixedReferenceTest extends AbstractImageCaptionFixedTesting {
