...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphTipTestCase} (ruby engine) .
 */
public class AdmonitionParagraphTipReferenceTest extends AbstractAdmonitionParagraphTipTesting {
