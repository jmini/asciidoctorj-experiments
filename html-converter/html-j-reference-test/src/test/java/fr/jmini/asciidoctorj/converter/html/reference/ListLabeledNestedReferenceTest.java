...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledNestedTestCase} (ruby engine) .
 */
public class ListLabeledNestedReferenceTest extends AbstractListLabeledNestedTesting {
