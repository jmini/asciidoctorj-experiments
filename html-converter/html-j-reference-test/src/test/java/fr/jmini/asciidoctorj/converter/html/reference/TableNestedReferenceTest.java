...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.TableNestedTestCase} (ruby engine) .
 */
public class TableNestedReferenceTest extends AbstractTableNestedTesting {
