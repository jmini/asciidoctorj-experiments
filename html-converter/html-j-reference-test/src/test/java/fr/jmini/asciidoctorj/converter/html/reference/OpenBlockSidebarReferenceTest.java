...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockSidebarTestCase} (ruby engine) .
 */
public class OpenBlockSidebarReferenceTest extends AbstractOpenBlockSidebarTesting {
