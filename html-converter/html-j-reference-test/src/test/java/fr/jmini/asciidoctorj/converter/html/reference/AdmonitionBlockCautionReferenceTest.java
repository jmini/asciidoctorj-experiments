...
/**
 * Reference test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockCautionTestCase} (ruby engine) .
 */
public class AdmonitionBlockCautionReferenceTest extends AbstractAdmonitionBlockCautionTesting {
