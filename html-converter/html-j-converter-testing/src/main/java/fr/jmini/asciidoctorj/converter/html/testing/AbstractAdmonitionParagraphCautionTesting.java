...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphCautionTestCase;

public abstract class AbstractAdmonitionParagraphCautionTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphCautionTestCase();
