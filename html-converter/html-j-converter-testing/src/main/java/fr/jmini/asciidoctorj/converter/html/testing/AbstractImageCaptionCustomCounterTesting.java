...
import fr.jmini.asciidoctorj.testcases.ImageCaptionCustomCounterTestCase;

public abstract class AbstractImageCaptionCustomCounterTesting {

    protected AdocTestCase testCase = new ImageCaptionCustomCounterTestCase();
