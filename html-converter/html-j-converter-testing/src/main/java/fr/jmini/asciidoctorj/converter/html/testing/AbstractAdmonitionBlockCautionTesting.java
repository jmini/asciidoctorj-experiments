...
import fr.jmini.asciidoctorj.testcases.AdmonitionBlockCautionTestCase;

public abstract class AbstractAdmonitionBlockCautionTesting {

    protected AdocTestCase testCase = new AdmonitionBlockCautionTestCase();
