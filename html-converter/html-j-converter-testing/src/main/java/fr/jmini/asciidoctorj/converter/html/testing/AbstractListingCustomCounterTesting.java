...
import fr.jmini.asciidoctorj.testcases.ListingCustomCounterTestCase;

public abstract class AbstractListingCustomCounterTesting {

    protected AdocTestCase testCase = new ListingCustomCounterTestCase();
