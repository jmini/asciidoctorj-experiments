...
import fr.jmini.asciidoctorj.testcases.ShowTitleTrueTestCase;

public abstract class AbstractShowTitleTrueTesting {

    protected AdocTestCase testCase = new ShowTitleTrueTestCase();
