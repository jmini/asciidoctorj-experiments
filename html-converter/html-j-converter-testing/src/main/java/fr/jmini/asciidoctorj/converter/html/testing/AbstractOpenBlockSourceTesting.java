...
import fr.jmini.asciidoctorj.testcases.OpenBlockSourceTestCase;

public abstract class AbstractOpenBlockSourceTesting {

    protected AdocTestCase testCase = new OpenBlockSourceTestCase();
