...
import fr.jmini.asciidoctorj.testcases.OpenBlockSidebarTestCase;

public abstract class AbstractOpenBlockSidebarTesting {

    protected AdocTestCase testCase = new OpenBlockSidebarTestCase();
