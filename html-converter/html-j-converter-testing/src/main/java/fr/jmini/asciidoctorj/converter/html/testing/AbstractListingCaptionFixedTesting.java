...
import fr.jmini.asciidoctorj.testcases.ListingCaptionFixedTestCase;

public abstract class AbstractListingCaptionFixedTesting {

    protected AdocTestCase testCase = new ListingCaptionFixedTestCase();
