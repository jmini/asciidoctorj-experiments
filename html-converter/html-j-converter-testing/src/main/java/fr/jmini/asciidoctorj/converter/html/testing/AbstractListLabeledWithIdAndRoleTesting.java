...
import fr.jmini.asciidoctorj.testcases.ListLabeledWithIdAndRoleTestCase;

public abstract class AbstractListLabeledWithIdAndRoleTesting {

    protected AdocTestCase testCase = new ListLabeledWithIdAndRoleTestCase();
