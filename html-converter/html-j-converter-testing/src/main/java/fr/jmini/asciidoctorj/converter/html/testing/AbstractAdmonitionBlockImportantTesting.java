...
import fr.jmini.asciidoctorj.testcases.AdmonitionBlockImportantTestCase;

public abstract class AbstractAdmonitionBlockImportantTesting {

    protected AdocTestCase testCase = new AdmonitionBlockImportantTestCase();
