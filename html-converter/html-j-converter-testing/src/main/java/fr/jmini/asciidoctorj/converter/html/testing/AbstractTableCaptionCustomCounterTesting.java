...
import fr.jmini.asciidoctorj.testcases.TableCaptionCustomCounterTestCase;

public abstract class AbstractTableCaptionCustomCounterTesting {

    protected AdocTestCase testCase = new TableCaptionCustomCounterTestCase();
