...
import fr.jmini.asciidoctorj.testcases.TableFooterRowTestCase;

public abstract class AbstractTableFooterRowTesting {

    protected AdocTestCase testCase = new TableFooterRowTestCase();
