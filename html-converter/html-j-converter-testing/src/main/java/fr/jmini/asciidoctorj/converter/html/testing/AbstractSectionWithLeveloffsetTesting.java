...
import fr.jmini.asciidoctorj.testcases.SectionWithLeveloffsetTestCase;

public abstract class AbstractSectionWithLeveloffsetTesting {

    protected AdocTestCase testCase = new SectionWithLeveloffsetTestCase();
