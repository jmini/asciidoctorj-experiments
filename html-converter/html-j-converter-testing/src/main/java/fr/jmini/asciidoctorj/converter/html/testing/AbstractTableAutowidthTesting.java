...
import fr.jmini.asciidoctorj.testcases.TableAutowidthTestCase;

public abstract class AbstractTableAutowidthTesting {

    protected AdocTestCase testCase = new TableAutowidthTestCase();
