...
import fr.jmini.asciidoctorj.testcases.ExampleCaptionCustomCounterTestCase;

public abstract class AbstractExampleCaptionCustomCounterTesting {

    protected AdocTestCase testCase = new ExampleCaptionCustomCounterTestCase();
