...
import fr.jmini.asciidoctorj.testcases.ListLabeledTestCase;

public abstract class AbstractListLabeledTesting {

    protected AdocTestCase testCase = new ListLabeledTestCase();
