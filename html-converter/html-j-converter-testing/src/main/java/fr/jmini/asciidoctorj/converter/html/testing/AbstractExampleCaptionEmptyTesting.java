...
import fr.jmini.asciidoctorj.testcases.ExampleCaptionEmptyTestCase;

public abstract class AbstractExampleCaptionEmptyTesting {

    protected AdocTestCase testCase = new ExampleCaptionEmptyTestCase();
