...
import fr.jmini.asciidoctorj.testcases.TableCaptionEmptyTestCase;

public abstract class AbstractTableCaptionEmptyTesting {

    protected AdocTestCase testCase = new TableCaptionEmptyTestCase();
