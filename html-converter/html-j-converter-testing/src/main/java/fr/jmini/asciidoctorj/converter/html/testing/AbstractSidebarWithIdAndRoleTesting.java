...
import fr.jmini.asciidoctorj.testcases.SidebarWithIdAndRoleTestCase;

public abstract class AbstractSidebarWithIdAndRoleTesting {

    protected AdocTestCase testCase = new SidebarWithIdAndRoleTestCase();
