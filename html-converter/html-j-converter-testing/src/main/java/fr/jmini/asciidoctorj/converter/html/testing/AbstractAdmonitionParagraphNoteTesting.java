...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphNoteTestCase;

public abstract class AbstractAdmonitionParagraphNoteTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphNoteTestCase();
