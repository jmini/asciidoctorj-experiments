...
import fr.jmini.asciidoctorj.testcases.ExampleCaptionFixedTestCase;

public abstract class AbstractExampleCaptionFixedTesting {

    protected AdocTestCase testCase = new ExampleCaptionFixedTestCase();
