...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningTestCase;

public abstract class AbstractAdmonitionParagraphWarningTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphWarningTestCase();
