...
import fr.jmini.asciidoctorj.testcases.TableWidthTestCase;

public abstract class AbstractTableWidthTesting {

    protected AdocTestCase testCase = new TableWidthTestCase();
