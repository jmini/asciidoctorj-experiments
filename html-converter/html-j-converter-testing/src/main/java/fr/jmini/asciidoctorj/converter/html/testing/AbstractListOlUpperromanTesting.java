...
public abstract class AbstractListOlUpperromanTesting {
    ...
    // tag::expected-html[]
    public static final String EXPECTED_HTML = "<div class=\"olist upperroman\">\n" +
    ...
    public void checkAst(Document astDocument) {
        ...
        assertThat(list1.getAttributes()).containsEntry("1", "upperroman")
                .containsEntry("style", "upperroman");
