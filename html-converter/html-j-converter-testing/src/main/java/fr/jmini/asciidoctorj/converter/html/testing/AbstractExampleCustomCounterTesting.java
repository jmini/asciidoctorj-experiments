...
import fr.jmini.asciidoctorj.testcases.ExampleCustomCounterTestCase;

public abstract class AbstractExampleCustomCounterTesting {

    protected AdocTestCase testCase = new ExampleCustomCounterTestCase();
