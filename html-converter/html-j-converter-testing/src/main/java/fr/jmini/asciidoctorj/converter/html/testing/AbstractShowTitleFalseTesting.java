...
import fr.jmini.asciidoctorj.testcases.ShowTitleFalseTestCase;

public abstract class AbstractShowTitleFalseTesting {

    protected AdocTestCase testCase = new ShowTitleFalseTestCase();
