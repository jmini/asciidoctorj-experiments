...
import fr.jmini.asciidoctorj.testcases.QuoteWithoutBlockDelimiterTestCase;

public abstract class AbstractQuoteWithoutBlockDelimiterTesting {

    protected AdocTestCase testCase = new QuoteWithoutBlockDelimiterTestCase();
