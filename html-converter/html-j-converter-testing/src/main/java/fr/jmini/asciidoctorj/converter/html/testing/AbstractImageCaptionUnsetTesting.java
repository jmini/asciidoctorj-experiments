...
import fr.jmini.asciidoctorj.testcases.ImageCaptionUnsetTestCase;

public abstract class AbstractImageCaptionUnsetTesting {

    protected AdocTestCase testCase = new ImageCaptionUnsetTestCase();
