...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningWithIdAndRoleTestCase;

public abstract class AbstractAdmonitionParagraphWarningWithIdAndRoleTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphWarningWithIdAndRoleTestCase();
