...
import fr.jmini.asciidoctorj.testcases.ListOlLoweralphaTestCase;

public abstract class AbstractListOlLoweralphaTesting {

    protected AdocTestCase testCase = new ListOlLoweralphaTestCase();
