...
import fr.jmini.asciidoctorj.testcases.ExampleCaptionUnsetTestCase;

public abstract class AbstractExampleCaptionUnsetTesting {

    protected AdocTestCase testCase = new ExampleCaptionUnsetTestCase();
