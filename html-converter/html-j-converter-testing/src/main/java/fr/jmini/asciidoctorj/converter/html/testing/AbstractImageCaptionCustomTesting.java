...
import fr.jmini.asciidoctorj.testcases.ImageCaptionCustomTestCase;

public abstract class AbstractImageCaptionCustomTesting {

    protected AdocTestCase testCase = new ImageCaptionCustomTestCase();
