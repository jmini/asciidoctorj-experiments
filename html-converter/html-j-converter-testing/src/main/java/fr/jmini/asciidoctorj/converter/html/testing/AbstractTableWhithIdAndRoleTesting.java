...
import fr.jmini.asciidoctorj.testcases.TableWhithIdAndRoleTestCase;

public abstract class AbstractTableWhithIdAndRoleTesting {

    protected AdocTestCase testCase = new TableWhithIdAndRoleTestCase();
