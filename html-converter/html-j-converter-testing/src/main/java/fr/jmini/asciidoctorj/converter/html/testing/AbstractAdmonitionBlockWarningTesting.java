...
import fr.jmini.asciidoctorj.testcases.AdmonitionBlockWarningTestCase;

public abstract class AbstractAdmonitionBlockWarningTesting {

    protected AdocTestCase testCase = new AdmonitionBlockWarningTestCase();
