...
import fr.jmini.asciidoctorj.testcases.ImageCaptionEmptyTestCase;

public abstract class AbstractImageCaptionEmptyTesting {

    protected AdocTestCase testCase = new ImageCaptionEmptyTestCase();
