...
import fr.jmini.asciidoctorj.testcases.TableCaptionFixedTestCase;

public abstract class AbstractTableCaptionFixedTesting {

    protected AdocTestCase testCase = new TableCaptionFixedTestCase();
