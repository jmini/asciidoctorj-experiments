...
import fr.jmini.asciidoctorj.testcases.ImageCaptionFixedTestCase;

public abstract class AbstractImageCaptionFixedTesting {

    protected AdocTestCase testCase = new ImageCaptionFixedTestCase();
