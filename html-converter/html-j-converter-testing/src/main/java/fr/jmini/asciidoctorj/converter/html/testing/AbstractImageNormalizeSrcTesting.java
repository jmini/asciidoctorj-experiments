...
import fr.jmini.asciidoctorj.testcases.ImageNormalizeSrcTestCase;

public abstract class AbstractImageNormalizeSrcTesting {

    protected AdocTestCase testCase = new ImageNormalizeSrcTestCase();
