...
import fr.jmini.asciidoctorj.testcases.ListingCaptionEmptyTestCase;

public abstract class AbstractListingCaptionEmptyTesting {

    protected AdocTestCase testCase = new ListingCaptionEmptyTestCase();
