...
import fr.jmini.asciidoctorj.testcases.NoTitleUnsetTestCase;

public abstract class AbstractNoTitleUnsetTesting {

    protected AdocTestCase testCase = new NoTitleUnsetTestCase();
