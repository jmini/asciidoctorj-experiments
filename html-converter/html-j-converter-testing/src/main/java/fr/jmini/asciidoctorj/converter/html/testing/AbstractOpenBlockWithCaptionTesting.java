...
import fr.jmini.asciidoctorj.testcases.OpenBlockWithCaptionTestCase;

public abstract class AbstractOpenBlockWithCaptionTesting {

    protected AdocTestCase testCase = new OpenBlockWithCaptionTestCase();
