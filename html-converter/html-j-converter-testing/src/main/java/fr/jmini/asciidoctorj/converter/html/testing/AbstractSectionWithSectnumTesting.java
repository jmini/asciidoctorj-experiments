...
import fr.jmini.asciidoctorj.testcases.SectionWithSectnumTestCase;

public abstract class AbstractSectionWithSectnumTesting {

    protected AdocTestCase testCase = new SectionWithSectnumTestCase();
