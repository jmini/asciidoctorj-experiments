...
import fr.jmini.asciidoctorj.testcases.ListingUnsetPrewrapTestCase;

public abstract class AbstractListingUnsetPrewrapTesting {

    protected AdocTestCase testCase = new ListingUnsetPrewrapTestCase();
