...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphImportantTestCase;

public abstract class AbstractAdmonitionParagraphImportantTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphImportantTestCase();
