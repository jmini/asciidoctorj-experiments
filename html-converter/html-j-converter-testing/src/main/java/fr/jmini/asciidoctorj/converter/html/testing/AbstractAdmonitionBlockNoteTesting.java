...
import fr.jmini.asciidoctorj.testcases.AdmonitionBlockNoteTestCase;

public abstract class AbstractAdmonitionBlockNoteTesting {

    protected AdocTestCase testCase = new AdmonitionBlockNoteTestCase();
