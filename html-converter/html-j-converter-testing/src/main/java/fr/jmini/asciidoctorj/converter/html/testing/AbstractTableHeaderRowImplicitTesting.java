...
import fr.jmini.asciidoctorj.testcases.TableHeaderRowImplicitTestCase;

public abstract class AbstractTableHeaderRowImplicitTesting {

    protected AdocTestCase testCase = new TableHeaderRowImplicitTestCase();
