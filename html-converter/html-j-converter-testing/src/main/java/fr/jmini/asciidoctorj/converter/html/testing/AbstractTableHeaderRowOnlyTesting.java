...
import fr.jmini.asciidoctorj.testcases.TableHeaderRowOnlyTestCase;

public abstract class AbstractTableHeaderRowOnlyTesting {

    protected AdocTestCase testCase = new TableHeaderRowOnlyTestCase();
