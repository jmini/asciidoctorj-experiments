...
import fr.jmini.asciidoctorj.testcases.AdmonitionBlockTipTestCase;

public abstract class AbstractAdmonitionBlockTipTesting {

    protected AdocTestCase testCase = new AdmonitionBlockTipTestCase();
