...
import fr.jmini.asciidoctorj.testcases.OpenBlockWithIdAndRoleTestCase;

public abstract class AbstractOpenBlockWithIdAndRoleTesting {

    protected AdocTestCase testCase = new OpenBlockWithIdAndRoleTestCase();
