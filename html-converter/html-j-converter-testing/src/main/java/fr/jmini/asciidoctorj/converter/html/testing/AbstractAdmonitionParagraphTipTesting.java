...
import fr.jmini.asciidoctorj.testcases.AdmonitionParagraphTipTestCase;

public abstract class AbstractAdmonitionParagraphTipTesting {

    protected AdocTestCase testCase = new AdmonitionParagraphTipTestCase();
