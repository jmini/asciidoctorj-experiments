...
import fr.jmini.asciidoctorj.testcases.ExampleCaptionCustomTestCase;

public abstract class AbstractExampleCaptionCustomTesting {

    protected AdocTestCase testCase = new ExampleCaptionCustomTestCase();
