...
import fr.jmini.asciidoctorj.testcases.SectionCustomIdAttributesTestCase;

public abstract class AbstractSectionCustomIdAttributesTesting {

    protected AdocTestCase testCase = new SectionCustomIdAttributesTestCase();
