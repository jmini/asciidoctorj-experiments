...
import fr.jmini.asciidoctorj.testcases.ImageImagesdirTestCase;

public abstract class AbstractImageImagesdirTesting {

    protected AdocTestCase testCase = new ImageImagesdirTestCase();
