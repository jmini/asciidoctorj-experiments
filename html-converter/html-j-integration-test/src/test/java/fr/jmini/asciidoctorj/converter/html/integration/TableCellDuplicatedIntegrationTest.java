...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCellDuplicatedTestCase} (ruby engine with the java html backend) .
 */
public class TableCellDuplicatedIntegrationTest extends AbstractTableCellDuplicatedTesting {
