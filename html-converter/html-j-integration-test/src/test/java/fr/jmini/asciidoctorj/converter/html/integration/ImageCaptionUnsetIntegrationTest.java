...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractImageCaptionUnsetTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionUnsetTestCase} (ruby engine with the java html backend) .
 */
public class ImageCaptionUnsetIntegrationTest extends AbstractImageCaptionUnsetTesting {
