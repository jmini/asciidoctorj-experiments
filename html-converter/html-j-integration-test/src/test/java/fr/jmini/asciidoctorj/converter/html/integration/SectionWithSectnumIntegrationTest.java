...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SectionWithSectnumTestCase} (ruby engine with the java html backend) .
 */
public class SectionWithSectnumIntegrationTest extends AbstractSectionWithSectnumTesting {
