...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableTestCase} (ruby engine with the java html backend) .
 */
public class TableIntegrationTest extends AbstractTableTesting {
