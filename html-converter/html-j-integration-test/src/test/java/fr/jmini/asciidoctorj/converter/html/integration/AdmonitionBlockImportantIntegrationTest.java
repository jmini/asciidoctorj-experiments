...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockImportantTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionBlockImportantIntegrationTest extends AbstractAdmonitionBlockImportantTesting {
