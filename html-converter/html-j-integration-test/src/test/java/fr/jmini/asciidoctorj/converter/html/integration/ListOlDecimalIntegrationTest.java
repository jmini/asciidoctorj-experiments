...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlDecimalTestCase} (ruby engine with the java html backend) .
 */
public class ListOlDecimalIntegrationTest extends AbstractListOlDecimalTesting {
