...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlTestCase} (ruby engine with the java html backend) .
 */
public class ListOlIntegrationTest extends AbstractListOlTesting {
