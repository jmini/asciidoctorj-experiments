...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ShowTitleFalseTestCase} (ruby engine with the java html backend) .
 */
public class ShowTitleFalseIntegrationTest extends AbstractShowTitleFalseTesting {
