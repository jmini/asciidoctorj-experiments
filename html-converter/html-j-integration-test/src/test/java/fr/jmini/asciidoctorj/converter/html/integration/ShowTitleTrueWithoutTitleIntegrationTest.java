...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ShowTitleTrueWithoutTitleTestCase} (ruby engine with the java html backend) .
 */
public class ShowTitleTrueWithoutTitleIntegrationTest extends AbstractShowTitleTrueWithoutTitleTesting {
