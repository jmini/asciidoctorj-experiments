...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableAutowidthSpreadTestCase} (ruby engine with the java html backend) .
 */
public class TableAutowidthSpreadIntegrationTest extends AbstractTableAutowidthSpreadTesting {
