...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SectionCustomIdAttributesTestCase} (ruby engine with the java html backend) .
 */
public class SectionCustomIdAttributesIntegrationTest extends AbstractSectionCustomIdAttributesTesting {
