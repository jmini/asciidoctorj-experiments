...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableAutowidthTestCase} (ruby engine with the java html backend) .
 */
public class TableAutowidthIntegrationTest extends AbstractTableAutowidthTesting {
