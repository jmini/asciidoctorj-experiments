...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridRowsTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderGridRowsIntegrationTest extends AbstractTableBorderGridRowsTesting {
