...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionParagraphWarningIntegrationTest extends AbstractAdmonitionParagraphWarningTesting {
