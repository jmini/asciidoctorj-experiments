...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionCustomCounterTestCase} (ruby engine with the java html backend) .
 */
public class ImageCaptionCustomCounterIntegrationTest extends AbstractImageCaptionCustomCounterTesting {
