...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionCustomCounterTestCase} (ruby engine with the java html backend) .
 */
public class ListingCaptionCustomCounterIntegrationTest extends AbstractListingCaptionCustomCounterTesting {
