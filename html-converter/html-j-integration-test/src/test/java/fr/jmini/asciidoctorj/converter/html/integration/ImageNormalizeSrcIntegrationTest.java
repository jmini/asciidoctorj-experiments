...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageNormalizeSrcTestCase} (ruby engine with the java html backend) .
 */
public class ImageNormalizeSrcIntegrationTest extends AbstractImageNormalizeSrcTesting {
