...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionFixedTestCase} (ruby engine with the java html backend) .
 */
public class ExampleCaptionFixedIntegrationTest extends AbstractExampleCaptionFixedTesting {
