...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableWidthTestCase} (ruby engine with the java html backend) .
 */
public class TableWidthIntegrationTest extends AbstractTableWidthTesting {
