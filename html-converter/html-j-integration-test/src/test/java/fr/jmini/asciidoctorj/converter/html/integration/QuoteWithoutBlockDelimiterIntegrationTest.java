...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.QuoteWithoutBlockDelimiterTestCase} (ruby engine with the java html backend) .
 */
public class QuoteWithoutBlockDelimiterIntegrationTest extends AbstractQuoteWithoutBlockDelimiterTesting {
