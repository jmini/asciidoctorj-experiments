...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionCustomCounterTestCase} (ruby engine with the java html backend) .
 */
public class ExampleCaptionCustomCounterIntegrationTest extends AbstractExampleCaptionCustomCounterTesting {
