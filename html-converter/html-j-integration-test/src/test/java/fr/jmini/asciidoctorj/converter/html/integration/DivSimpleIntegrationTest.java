...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.DivSimpleTestCase} (ruby engine with the java html backend) .
 */
public class DivSimpleIntegrationTest extends AbstractDivSimpleTesting {
