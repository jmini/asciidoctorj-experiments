...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleNestedTestCase} (ruby engine with the java html backend) .
 */
public class ExampleNestedIntegrationTest extends AbstractExampleNestedTesting {
