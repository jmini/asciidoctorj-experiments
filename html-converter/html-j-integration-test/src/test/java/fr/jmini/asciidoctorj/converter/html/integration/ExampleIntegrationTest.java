...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleTestCase} (ruby engine with the java html backend) .
 */
public class ExampleIntegrationTest extends AbstractExampleTesting {
