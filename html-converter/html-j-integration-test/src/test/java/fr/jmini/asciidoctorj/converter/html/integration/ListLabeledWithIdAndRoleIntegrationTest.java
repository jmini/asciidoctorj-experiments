...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class ListLabeledWithIdAndRoleIntegrationTest extends AbstractListLabeledWithIdAndRoleTesting {
