...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableNestedTestCase} (ruby engine with the java html backend) .
 */
public class TableNestedIntegrationTest extends AbstractTableNestedTesting {
