...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowNoheaderTestCase} (ruby engine with the java html backend) .
 */
public class TableHeaderRowNoheaderIntegrationTest extends AbstractTableHeaderRowNoheaderTesting {
