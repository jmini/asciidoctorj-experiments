...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderFrameSidesTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderFrameSidesIntegrationTest extends AbstractTableBorderFrameSidesTesting {
