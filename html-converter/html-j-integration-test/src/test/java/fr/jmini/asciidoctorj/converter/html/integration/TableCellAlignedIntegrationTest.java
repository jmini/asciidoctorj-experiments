...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCellAlignedTestCase} (ruby engine with the java html backend) .
 */
public class TableCellAlignedIntegrationTest extends AbstractTableCellAlignedTesting {
