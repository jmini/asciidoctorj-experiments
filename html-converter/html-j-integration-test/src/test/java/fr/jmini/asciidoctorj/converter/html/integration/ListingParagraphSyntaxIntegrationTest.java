...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingParagraphSyntaxTestCase} (ruby engine with the java html backend) .
 */
public class ListingParagraphSyntaxIntegrationTest extends AbstractListingParagraphSyntaxTesting {
