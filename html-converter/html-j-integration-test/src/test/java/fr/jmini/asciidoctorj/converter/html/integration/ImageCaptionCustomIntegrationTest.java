...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionCustomTestCase} (ruby engine with the java html backend) .
 */
public class ImageCaptionCustomIntegrationTest extends AbstractImageCaptionCustomTesting {
