...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractSidebarTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SidebarTestCase} (ruby engine with the java html backend) .
 */
public class SidebarIntegrationTest extends AbstractSidebarTesting {
