...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowTestCase} (ruby engine with the java html backend) .
 */
public class TableHeaderRowIntegrationTest extends AbstractTableHeaderRowTesting {
