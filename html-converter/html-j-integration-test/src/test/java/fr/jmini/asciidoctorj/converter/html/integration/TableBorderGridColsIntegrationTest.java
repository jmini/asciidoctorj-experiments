...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridColsTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderGridColsIntegrationTest extends AbstractTableBorderGridColsTesting {
