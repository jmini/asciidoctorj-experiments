...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledNestedMixedTestCase} (ruby engine with the java html backend) .
 */
public class ListLabeledNestedMixedIntegrationTest extends AbstractListLabeledNestedMixedTesting {
