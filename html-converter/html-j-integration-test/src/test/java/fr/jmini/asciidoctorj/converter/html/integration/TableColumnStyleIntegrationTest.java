...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableColumnStyleTestCase} (ruby engine with the java html backend) .
 */
public class TableColumnStyleIntegrationTest extends AbstractTableColumnStyleTesting {
