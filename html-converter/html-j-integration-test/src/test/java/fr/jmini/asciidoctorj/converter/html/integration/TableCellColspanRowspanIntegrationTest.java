...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCellColspanRowspanTestCase} (ruby engine with the java html backend) .
 */
public class TableCellColspanRowspanIntegrationTest extends AbstractTableCellColspanRowspanTesting {
