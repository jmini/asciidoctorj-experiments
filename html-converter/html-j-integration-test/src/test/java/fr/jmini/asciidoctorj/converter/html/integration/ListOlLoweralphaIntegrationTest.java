...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlLoweralphaTestCase} (ruby engine with the java html backend) .
 */
public class ListOlLoweralphaIntegrationTest extends AbstractListOlLoweralphaTesting {
