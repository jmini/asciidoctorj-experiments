...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderFrameNoneTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderFrameNoneIntegrationTest extends AbstractTableBorderFrameNoneTesting {
