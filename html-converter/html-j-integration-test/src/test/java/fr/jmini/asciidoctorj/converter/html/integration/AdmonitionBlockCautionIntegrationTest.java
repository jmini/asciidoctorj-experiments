...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockCautionTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionBlockCautionIntegrationTest extends AbstractAdmonitionBlockCautionTesting {
