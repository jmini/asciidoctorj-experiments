...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphImportantTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionParagraphImportantIntegrationTest extends AbstractAdmonitionParagraphImportantTesting {
