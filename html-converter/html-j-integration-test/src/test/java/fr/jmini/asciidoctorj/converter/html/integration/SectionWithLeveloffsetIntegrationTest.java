...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SectionWithLeveloffsetTestCase} (ruby engine with the java html backend) .
 */
public class SectionWithLeveloffsetIntegrationTest extends AbstractSectionWithLeveloffsetTesting {
