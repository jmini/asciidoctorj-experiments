...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractAdmonitionParagraphTipTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphTipTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionParagraphTipIntegrationTest extends AbstractAdmonitionParagraphTipTesting {
