...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractImageTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageTestCase} (ruby engine with the java html backend) .
 */
public class ImageIntegrationTest extends AbstractImageTesting {
