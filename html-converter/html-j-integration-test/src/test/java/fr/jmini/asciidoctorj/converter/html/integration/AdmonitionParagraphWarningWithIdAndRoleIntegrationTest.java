...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphWarningWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionParagraphWarningWithIdAndRoleIntegrationTest extends AbstractAdmonitionParagraphWarningWithIdAndRoleTesting {
