...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableFooterRowTestCase} (ruby engine with the java html backend) .
 */
public class TableFooterRowIntegrationTest extends AbstractTableFooterRowTesting {
