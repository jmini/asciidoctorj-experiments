...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingWithoutBlockDelimiterTestCase} (ruby engine with the java html backend) .
 */
public class ListingWithoutBlockDelimiterIntegrationTest extends AbstractListingWithoutBlockDelimiterTesting {
