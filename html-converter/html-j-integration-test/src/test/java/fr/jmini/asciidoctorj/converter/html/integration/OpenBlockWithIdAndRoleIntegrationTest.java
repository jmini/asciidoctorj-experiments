...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractOpenBlockWithIdAndRoleTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class OpenBlockWithIdAndRoleIntegrationTest extends AbstractOpenBlockWithIdAndRoleTesting {
