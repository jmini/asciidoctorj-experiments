...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionCustomCounterTestCase} (ruby engine with the java html backend) .
 */
public class TableCaptionCustomCounterIntegrationTest extends AbstractTableCaptionCustomCounterTesting {
