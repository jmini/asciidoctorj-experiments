...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCellRowspanTestCase} (ruby engine with the java html backend) .
 */
public class TableCellRowspanIntegrationTest extends AbstractTableCellRowspanTesting {
