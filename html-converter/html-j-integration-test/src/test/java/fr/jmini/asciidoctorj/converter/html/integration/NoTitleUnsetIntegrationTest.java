...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractNoTitleUnsetTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.NoTitleUnsetTestCase} (ruby engine with the java html backend) .
 */
public class NoTitleUnsetIntegrationTest extends AbstractNoTitleUnsetTesting {
