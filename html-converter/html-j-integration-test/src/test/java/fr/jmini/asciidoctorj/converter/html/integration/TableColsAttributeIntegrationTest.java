...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableColsAttributeTestCase} (ruby engine with the java html backend) .
 */
public class TableColsAttributeIntegrationTest extends AbstractTableColsAttributeTesting {
