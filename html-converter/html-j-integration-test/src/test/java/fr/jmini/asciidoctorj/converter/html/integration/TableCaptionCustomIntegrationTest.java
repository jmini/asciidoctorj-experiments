...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionCustomTestCase} (ruby engine with the java html backend) .
 */
public class TableCaptionCustomIntegrationTest extends AbstractTableCaptionCustomTesting {
