...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ShowTitleTrueTestCase} (ruby engine with the java html backend) .
 */
public class ShowTitleTrueIntegrationTest extends AbstractShowTitleTrueTesting {
