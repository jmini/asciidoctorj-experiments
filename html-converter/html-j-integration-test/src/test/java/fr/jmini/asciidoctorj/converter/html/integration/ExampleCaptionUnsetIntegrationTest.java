...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionUnsetTestCase} (ruby engine with the java html backend) .
 */
public class ExampleCaptionUnsetIntegrationTest extends AbstractExampleCaptionUnsetTesting {
