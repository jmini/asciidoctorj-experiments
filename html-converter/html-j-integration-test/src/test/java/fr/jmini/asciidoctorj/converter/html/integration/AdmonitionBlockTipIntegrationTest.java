...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractAdmonitionBlockTipTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionBlockTipTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionBlockTipIntegrationTest extends AbstractAdmonitionBlockTipTesting {
