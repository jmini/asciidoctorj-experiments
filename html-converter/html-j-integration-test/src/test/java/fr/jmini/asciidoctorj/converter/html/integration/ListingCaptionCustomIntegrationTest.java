...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionCustomTestCase} (ruby engine with the java html backend) .
 */
public class ListingCaptionCustomIntegrationTest extends AbstractListingCaptionCustomTesting {
