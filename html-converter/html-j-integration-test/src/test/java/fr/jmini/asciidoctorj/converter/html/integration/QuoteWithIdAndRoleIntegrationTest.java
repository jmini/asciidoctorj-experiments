...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.QuoteWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class QuoteWithIdAndRoleIntegrationTest extends AbstractQuoteWithIdAndRoleTesting {
