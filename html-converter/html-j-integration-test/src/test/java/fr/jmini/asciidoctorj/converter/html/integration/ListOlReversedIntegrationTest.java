...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlReversedTestCase} (ruby engine with the java html backend) .
 */
public class ListOlReversedIntegrationTest extends AbstractListOlReversedTesting {
