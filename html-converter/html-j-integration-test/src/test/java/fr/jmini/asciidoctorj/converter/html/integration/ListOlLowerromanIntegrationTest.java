...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlLowerromanTestCase} (ruby engine with the java html backend) .
 */
public class ListOlLowerromanIntegrationTest extends AbstractListOlLowerromanTesting {
