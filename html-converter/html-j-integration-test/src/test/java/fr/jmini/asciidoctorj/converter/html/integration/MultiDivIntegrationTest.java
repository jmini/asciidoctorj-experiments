...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.MultiDivTestCase} (ruby engine with the java html backend) .
 */
public class MultiDivIntegrationTest extends AbstractMultiDivTesting {
