...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionFixedTestCase} (ruby engine with the java html backend) .
 */
public class ImageCaptionFixedIntegrationTest extends AbstractImageCaptionFixedTesting {
