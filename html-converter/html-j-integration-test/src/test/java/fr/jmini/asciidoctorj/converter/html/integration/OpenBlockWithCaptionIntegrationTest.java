...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockWithCaptionTestCase} (ruby engine with the java html backend) .
 */
public class OpenBlockWithCaptionIntegrationTest extends AbstractOpenBlockWithCaptionTesting {
