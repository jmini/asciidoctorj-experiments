...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SidebarWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class SidebarWithIdAndRoleIntegrationTest extends AbstractSidebarWithIdAndRoleTesting {
