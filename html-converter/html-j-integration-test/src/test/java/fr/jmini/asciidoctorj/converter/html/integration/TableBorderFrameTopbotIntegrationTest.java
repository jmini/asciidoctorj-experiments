...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderFrameTopbotTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderFrameTopbotIntegrationTest extends AbstractTableBorderFrameTopbotTesting {
