...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlUpperalphaTestCase} (ruby engine with the java html backend) .
 */
public class ListOlUpperalphaIntegrationTest extends AbstractListOlUpperalphaTesting {
