...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowImplicitTestCase} (ruby engine with the java html backend) .
 */
public class TableHeaderRowImplicitIntegrationTest extends AbstractTableHeaderRowImplicitTesting {
