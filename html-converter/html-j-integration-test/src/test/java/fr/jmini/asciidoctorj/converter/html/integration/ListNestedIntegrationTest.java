...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListNestedTestCase} (ruby engine with the java html backend) .
 */
public class ListNestedIntegrationTest extends AbstractListNestedTesting {
