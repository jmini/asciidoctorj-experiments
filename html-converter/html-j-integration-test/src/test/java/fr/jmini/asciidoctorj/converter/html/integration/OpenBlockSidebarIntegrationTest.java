...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractOpenBlockSidebarTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockSidebarTestCase} (ruby engine with the java html backend) .
 */
public class OpenBlockSidebarIntegrationTest extends AbstractOpenBlockSidebarTesting {
