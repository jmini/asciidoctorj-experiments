...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListUlTestCase} (ruby engine with the java html backend) .
 */
public class ListUlIntegrationTest extends AbstractListUlTesting {
