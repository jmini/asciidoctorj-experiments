...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledNestedTestCase} (ruby engine with the java html backend) .
 */
public class ListLabeledNestedIntegrationTest extends AbstractListLabeledNestedTesting {
