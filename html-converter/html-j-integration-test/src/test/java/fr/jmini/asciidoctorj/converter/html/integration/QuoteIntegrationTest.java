...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.QuoteTestCase} (ruby engine with the java html backend) .
 */
public class QuoteIntegrationTest extends AbstractQuoteTesting {
