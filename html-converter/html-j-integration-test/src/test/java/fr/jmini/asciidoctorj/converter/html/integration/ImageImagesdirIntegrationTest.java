...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageImagesdirTestCase} (ruby engine with the java html backend) .
 */
public class ImageImagesdirIntegrationTest extends AbstractImageImagesdirTesting {
