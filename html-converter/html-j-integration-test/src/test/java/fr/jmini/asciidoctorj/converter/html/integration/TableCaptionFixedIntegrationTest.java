...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionFixedTestCase} (ruby engine with the java html backend) .
 */
public class TableCaptionFixedIntegrationTest extends AbstractTableCaptionFixedTesting {
