...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableBorderGridNoneTestCase} (ruby engine with the java html backend) .
 */
public class TableBorderGridNoneIntegrationTest extends AbstractTableBorderGridNoneTesting {
