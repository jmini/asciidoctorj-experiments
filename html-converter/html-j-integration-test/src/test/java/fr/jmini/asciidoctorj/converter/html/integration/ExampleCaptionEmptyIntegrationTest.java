...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionEmptyTestCase} (ruby engine with the java html backend) .
 */
public class ExampleCaptionEmptyIntegrationTest extends AbstractExampleCaptionEmptyTesting {
