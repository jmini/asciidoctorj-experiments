...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlLowergreekTestCase} (ruby engine with the java html backend) .
 */
public class ListOlLowergreekIntegrationTest extends AbstractListOlLowergreekTesting {
