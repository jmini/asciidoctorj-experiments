...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableColumnFormattingValignTestCase} (ruby engine with the java html backend) .
 */
public class TableColumnFormattingValignIntegrationTest extends AbstractTableColumnFormattingValignTesting {
