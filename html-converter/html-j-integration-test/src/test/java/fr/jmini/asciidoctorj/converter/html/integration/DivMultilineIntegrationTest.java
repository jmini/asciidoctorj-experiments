...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.DivMultilineTestCase} (ruby engine with the java html backend) .
 */
public class DivMultilineIntegrationTest extends AbstractDivMultilineTesting {
