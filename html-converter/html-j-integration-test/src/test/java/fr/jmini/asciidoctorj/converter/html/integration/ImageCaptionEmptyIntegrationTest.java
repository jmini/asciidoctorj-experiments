...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ImageCaptionEmptyTestCase} (ruby engine with the java html backend) .
 */
public class ImageCaptionEmptyIntegrationTest extends AbstractImageCaptionEmptyTesting {
