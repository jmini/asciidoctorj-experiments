...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.HorizontalRuleTestCase} (ruby engine with the java html backend) .
 */
public class HorizontalRuleIntegrationTest extends AbstractHorizontalRuleTesting {
