...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SectionTestCase} (ruby engine with the java html backend) .
 */
public class SectionIntegrationTest extends AbstractSectionTesting {
