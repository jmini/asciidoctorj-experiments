...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ExampleCaptionCustomTestCase} (ruby engine with the java html backend) .
 */
public class ExampleCaptionCustomIntegrationTest extends AbstractExampleCaptionCustomTesting {
