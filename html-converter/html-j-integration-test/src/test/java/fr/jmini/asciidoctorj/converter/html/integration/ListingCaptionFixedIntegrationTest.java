...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionFixedTestCase} (ruby engine with the java html backend) .
 */
public class ListingCaptionFixedIntegrationTest extends AbstractListingCaptionFixedTesting {
