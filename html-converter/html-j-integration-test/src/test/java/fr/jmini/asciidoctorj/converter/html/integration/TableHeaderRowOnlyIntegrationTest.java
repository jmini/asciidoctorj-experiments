...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableHeaderRowOnlyTestCase} (ruby engine with the java html backend) .
 */
public class TableHeaderRowOnlyIntegrationTest extends AbstractTableHeaderRowOnlyTesting {
