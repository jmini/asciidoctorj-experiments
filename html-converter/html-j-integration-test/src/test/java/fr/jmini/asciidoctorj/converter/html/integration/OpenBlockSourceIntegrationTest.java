...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractOpenBlockSourceTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockSourceTestCase} (ruby engine with the java html backend) .
 */
public class OpenBlockSourceIntegrationTest extends AbstractOpenBlockSourceTesting {
