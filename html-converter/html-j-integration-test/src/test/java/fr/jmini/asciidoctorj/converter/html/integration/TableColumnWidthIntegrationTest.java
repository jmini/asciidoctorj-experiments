...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableColumnWidthTestCase} (ruby engine with the java html backend) .
 */
public class TableColumnWidthIntegrationTest extends AbstractTableColumnWidthTesting {
