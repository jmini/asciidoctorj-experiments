...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionUnsetTestCase} (ruby engine with the java html backend) .
 */
public class TableCaptionUnsetIntegrationTest extends AbstractTableCaptionUnsetTesting {
