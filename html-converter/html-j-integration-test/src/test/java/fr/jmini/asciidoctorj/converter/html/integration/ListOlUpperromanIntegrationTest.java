...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListOlUpperromanTestCase} (ruby engine with the java html backend) .
 */
public class ListOlUpperromanIntegrationTest extends AbstractListOlUpperromanTesting {
