...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableColumnFormattingHalignTestCase} (ruby engine with the java html backend) .
 */
public class TableColumnFormattingHalignIntegrationTest extends AbstractTableColumnFormattingHalignTesting {
