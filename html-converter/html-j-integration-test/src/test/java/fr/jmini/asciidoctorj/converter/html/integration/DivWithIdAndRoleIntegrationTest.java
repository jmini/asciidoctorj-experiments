...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.DivWithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class DivWithIdAndRoleIntegrationTest extends AbstractDivWithIdAndRoleTesting {
