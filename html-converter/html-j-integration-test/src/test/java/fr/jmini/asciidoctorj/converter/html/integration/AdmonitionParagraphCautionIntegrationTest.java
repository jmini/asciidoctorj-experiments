...
import fr.jmini.asciidoctorj.converter.html.testing.AbstractAdmonitionParagraphCautionTesting;
import fr.jmini.asciidoctorj.testcases.HtmlUtility;

/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.AdmonitionParagraphCautionTestCase} (ruby engine with the java html backend) .
 */
public class AdmonitionParagraphCautionIntegrationTest extends AbstractAdmonitionParagraphCautionTesting {
