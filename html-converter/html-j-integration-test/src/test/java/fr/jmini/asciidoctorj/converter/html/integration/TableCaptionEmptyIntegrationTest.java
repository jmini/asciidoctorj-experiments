...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCaptionEmptyTestCase} (ruby engine with the java html backend) .
 */
public class TableCaptionEmptyIntegrationTest extends AbstractTableCaptionEmptyTesting {
