...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListLabeledTestCase} (ruby engine with the java html backend) .
 */
public class ListLabeledIntegrationTest extends AbstractListLabeledTesting {
