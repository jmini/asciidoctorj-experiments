...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableWhithIdAndRoleTestCase} (ruby engine with the java html backend) .
 */
public class TableWhithIdAndRoleIntegrationTest extends AbstractTableWhithIdAndRoleTesting {
