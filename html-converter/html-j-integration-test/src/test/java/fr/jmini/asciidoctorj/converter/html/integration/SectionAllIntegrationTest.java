...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.SectionAllTestCase} (ruby engine with the java html backend) .
 */
public class SectionAllIntegrationTest extends AbstractSectionAllTesting {
