...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.OpenBlockTestCase} (ruby engine with the java html backend) .
 */
public class OpenBlockIntegrationTest extends AbstractOpenBlockTesting {
