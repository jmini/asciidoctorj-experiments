...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.ListingCaptionEmptyTestCase} (ruby engine with the java html backend) .
 */
public class ListingCaptionEmptyIntegrationTest extends AbstractListingCaptionEmptyTesting {
