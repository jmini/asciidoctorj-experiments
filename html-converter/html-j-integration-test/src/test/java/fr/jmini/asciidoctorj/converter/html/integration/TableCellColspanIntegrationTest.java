...
/**
 * Integration test for {@link fr.jmini.asciidoctorj.testcases.TableCellColspanTestCase} (ruby engine with the java html backend) .
 */
public class TableCellColspanIntegrationTest extends AbstractTableCellColspanTesting {
