 ...
 * <li>{@link fr.jmini.eadoc.EStructuralNode#getSourceLocation <em>Source
 * Location</em>}</li>
 * <li>{@link fr.jmini.eadoc.EStructuralNode#getSubstitutions
...
public interface EStructuralNode extends EContentNode, StructuralNode {
    ...
    /**
     * Sets the value of the '{@link fr.jmini.eadoc.EStructuralNode#getTitle
    ...
    /**
     * Sets the value of the '{@link fr.jmini.eadoc.EStructuralNode#getStyle
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Blocks</em>' containment reference list isn't
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Level</em>' attribute isn't clear, there really
     * should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link fr.jmini.eadoc.EStructuralNode#getLevel
     ...
     * <p>
     * If the meaning of the '<em>Source Location</em>' containment reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * '{@link fr.jmini.eadoc.EStructuralNode#getSourceLocation <em>Source
    ...
    /**
     * Returns the value of the '<em><b>Substitutions</b></em>' attribute list. The
     ...
     * 
     * @deprecated Please use {@linkplain #getTitle()} instead <!-- end-model-doc
     *             -->
     * @model unique="false" annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='return this.getTitle();'"
     * @generated
     */
    String title();
     ...
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> *
     * 
     * @deprecated Please use {@linkplain #getStyle()} instead <!-- end-model-doc
     *             -->
     * @model unique="false" annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='return this.getStyle();'"
     * @generated
     */
    String style();
     ...
     * @deprecated Please use {@linkplain #getBlocks()} instead <!-- end-model-doc
     *             -->
     * @model type="fr.jmini.eadoc.StructuralNodeList" unique="false"
     ...
     *        body='this.getBlocks().add(<%fr.jmini.eadoc.EadocUtility%>.convertStructuralNode(block));'"
     * @generated
     */
     ...
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> *
     * 
     * @deprecated Please use {@linkplain #getContent()} instead <!-- end-model-doc
     *             -->
     * @model unique="false" annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='return this.getContent();'"
     * @generated
     */
    Object content();
     ...
     *        annotation="http://www.eclipse.org/emf/2002/GenModel body='throw new
     ...
     * 
     * @model unique="false" annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='throw new <%java.lang.UnsupportedOperationException%>(\"Not
     *        implemented\");'"
     * @generated
     */
    String convert();
     ...
     * 
     * @model type="fr.jmini.eadoc.StructuralNodeList" unique="false"
     *        selectorType="fr.jmini.eadoc.ObjectObjectMap" selectorUnique="false"
     *        annotation="http://www.eclipse.org/emf/2002/GenModel body='throw new
     *        <%java.lang.UnsupportedOperationException%>(\"Not implemented\");'"
     * @generated
     */
     ...
     * @model substitutionUnique="false"
     *        annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='this.getSubstitutions().add(substitution);'"
     * @generated
     */
     ...
     * @model substitutionUnique="false"
     *        annotation="http://www.eclipse.org/emf/2002/GenModel
     *        body='this.getSubstitutions().add(0, substitution);'"
     * @generated
     */
