...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ERow</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.jmini.eadoc.impl.ERowImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ERowImpl extends MinimalEObjectImpl.Container implements ERow {
	/**
	...
	protected EClass eStaticClass() {
		return EadocPackage.Literals.EROW;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EadocPackage.EROW__CELLS:
				getCells().clear();
				getCells().addAll((Collection<? extends ECell>)newValue);
				return;
		}
