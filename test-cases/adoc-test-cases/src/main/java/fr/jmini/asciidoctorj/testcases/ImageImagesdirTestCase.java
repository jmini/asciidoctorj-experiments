...
assertThat(block1.getAttributes()).containsEntry("alt", "sunset").containsEntry("default-alt", "sunset").containsEntry("target", "sunset.jpg");
...
assertThat(block2.getAttributes()).containsEntry("alt", "cover").containsEntry("default-alt", "cover").containsEntry("target", "../cover.png");
...
assertThat(block3.getAttributes()).containsEntry("alt", "sunset").containsEntry("default-alt", "sunset").containsEntry("target", "http://asciidoctor.org/images/sunset.jpg");
...
assertThat(block4.getAttributes()).containsEntry("alt", "Tux").containsEntry("default-alt", "Tux").containsEntry("target", "https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png");
...
assertThat(block5.getAttributes()).containsEntry("alt", "sunset").containsEntry("default-alt", "sunset").containsEntry("target", "ftp://site.com/sunset.jpg");
...
assertThat(block6.getAttributes()).containsEntry("alt", "cover").containsEntry("default-alt", "cover").containsEntry("target", "file:///C:/absolute/cover.png");
...
assertThat(block7.getAttributes()).containsEntry("alt", "cover").containsEntry("default-alt", "cover").containsEntry("target", "file:///absolute/cover.png");
...
assertThat(block8.getAttributes()).containsEntry("alt", "sunset2").containsEntry("default-alt", "sunset2").containsEntry("target", "/absolute/sunset2.jpg");
...
map1.put("docdatetime", "2018-01-27 23:07:17 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:17 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:17 CET");
map1.put("localtime", "23:07:17 CET");
