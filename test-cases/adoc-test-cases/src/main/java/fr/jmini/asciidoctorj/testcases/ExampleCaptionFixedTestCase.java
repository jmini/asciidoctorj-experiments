...
public class ExampleCaptionFixedTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("caption", "Example A. ").containsEntry("style", "example").containsEntry("title", "first caption");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isEqualTo("Example A. ");
...
Block block3 = (Block) document1.getBlocks().get(1);
...
assertThat(block3.getAttributes()).containsEntry("style", "example").containsEntry("title", "second caption");
assertThat(block3.getRoles()).isNullOrEmpty();
assertThat(block3.isReftext()).isFalse();
assertThat(block3.getReftext()).isNull();
assertThat(block3.getCaption()).isEqualTo("Ex 1. ");
...
Block block4 = (Block) block3.getBlocks().get(0);
...
map1.put("docdatetime", "2018-01-27 23:07:09 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:09 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:09 CET");
map1.put("localtime", "23:07:09 CET");
...
when(mockBlock1.getCaption()).thenReturn("Example A. ");
...
when(mockBlock3.getCaption()).thenReturn("Ex 1. ");
