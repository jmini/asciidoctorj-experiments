...
public class QuoteWithoutBlockDelimiterTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("1", "quote").containsEntry("style", "quote");
...
assertThat(block1.getLines()).containsExactly("Lorem ipsum dolore.");
assertThat(block1.getSource()).isEqualTo("Lorem ipsum dolore.");
...
map1.put("docdatetime", "2018-01-27 23:07:52 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:52 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:52 CET");
map1.put("localtime", "23:07:52 CET");
...
when(mockBlock1.getLines()).thenReturn(Collections.singletonList("Lorem ipsum dolore."));
when(mockBlock1.getSource()).thenReturn("Lorem ipsum dolore.");
