...
assertThat(block1.getAttributes()).containsEntry("alt", "sunset0").containsEntry("default-alt", "sunset0").containsEntry("target", "./img/sunset0.png");
...
assertThat(block2.getAttributes()).containsEntry("alt", "sunset1").containsEntry("default-alt", "sunset1").containsEntry("target", "../../other/./sunset1.png");
...
Block block3 = (Block) document1.getBlocks().get(2);
...
assertThat(block3.getAttributes()).containsEntry("alt", "sunset2").containsEntry("default-alt", "sunset2").containsEntry("target", "img/./sunset2.png");
...
Block block4 = (Block) document1.getBlocks().get(3);
...
assertThat(block4.getAttributes()).containsEntry("alt", "sunset3").containsEntry("default-alt", "sunset3").containsEntry("target", "other/../img/sunset3.jpg");
...
Block block5 = (Block) document1.getBlocks().get(4);
...
assertThat(block5.getAttributes()).containsEntry("alt", "sunset4").containsEntry("default-alt", "sunset4").containsEntry("target", "other/.././img/sunset4.jpg");
...
Block block6 = (Block) document1.getBlocks().get(5);
...
assertThat(block6.getAttributes()).containsEntry("alt", "sunset5").containsEntry("default-alt", "sunset5").containsEntry("target", "other/../../img/sunset5.jpg");
...
Block block7 = (Block) document1.getBlocks().get(6);
...
assertThat(block7.getAttributes()).containsEntry("alt", "sunset6").containsEntry("default-alt", "sunset6").containsEntry("target", "./other/../../img/sunset6.jpg");
...
Block block8 = (Block) document1.getBlocks().get(7);
...
assertThat(block8.getAttributes()).containsEntry("alt", "sunset7").containsEntry("default-alt", "sunset7").containsEntry("target", "/absolute/../img/sunset7.jpg");
...
Block block9 = (Block) document1.getBlocks().get(8);
...
assertThat(block9.getAttributes()).containsEntry("alt", "sunset8").containsEntry("default-alt", "sunset8").containsEntry("target", "/absolute/../../sunset8.jpg");
...
map1.put("docdatetime", "2018-01-27 23:07:20 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:20 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:20 CET");
map1.put("localtime", "23:07:20 CET");
