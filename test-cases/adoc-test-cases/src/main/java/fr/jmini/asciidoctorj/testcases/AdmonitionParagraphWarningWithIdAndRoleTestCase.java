...
public class AdmonitionParagraphWarningWithIdAndRoleTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"idd\" class=\"admonitionblock warning rolee\">\n" +
            "<table>\n" +
            "<tbody>\n" +
            "<tr>\n" +
            "<td class=\"icon\">\n" +
...
assertThat(block1.getAttributes()).containsEntry("1", "#idd.rolee").containsEntry("id", "idd").containsEntry("name", "warning").containsEntry("role", "rolee").containsEntry("style", "WARNING").containsEntry("textlabel", "Warning");
...
map1.put("docdatetime", "2018-01-27 23:07:01 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:01 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:01 CET");
map1.put("localtime", "23:07:01 CET");
