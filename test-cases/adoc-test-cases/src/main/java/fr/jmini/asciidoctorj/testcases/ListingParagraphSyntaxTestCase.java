...
public class ListingParagraphSyntaxTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("1", "listing").containsEntry("style", "listing");
...
map1.put("docdatetime", "2018-01-27 23:07:44 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:44 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:44 CET");
map1.put("localtime", "23:07:44 CET");
...
when(mockBlock1.getLines()).thenReturn(Arrays.asList("This is an example of a paragraph styled with `listing`.", "Notice that the monospace markup is preserved in the output."));
when(mockBlock1.getSource()).thenReturn("This is an example of a paragraph styled with `listing`.\n" +
"Notice that the monospace markup is preserved in the output.");
