...
public class ListOlTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"iid\" class=\"olist arabic rrole\">\n" +
            "<ol class=\"arabic\">\n" +
            "<li> <p>Line one</p> </li>\n" +
            "<li> <p>Second line</p>\n" +
            "<div class=\"paragraph\">\n" +
...
assertThat(list1.getAttributes()).containsEntry("1", "#iid.rrole").containsEntry("id", "iid").containsEntry("role", "rrole").containsEntry("style", "arabic");
...
Block block1 = (Block) listItem2.getBlocks().get(0);
