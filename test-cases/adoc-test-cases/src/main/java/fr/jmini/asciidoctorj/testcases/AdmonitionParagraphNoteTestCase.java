...
public class AdmonitionParagraphNoteTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "Note\n" +
            "</div> </td>\n" +
            "<td class=\"content\"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. </td>\n" +
            "</tr>\n" +
            "</tbody>\n" +
            "</table>\n" +
            "</div>";
...
assertThat(block1.getAttributes()).containsEntry("name", "note").containsEntry("style", "NOTE").containsEntry("textlabel", "Note");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isEqualTo("Note");
assertThat(block1.getTitle()).isNull();
assertThat(block1.getStyle()).isEqualTo("NOTE");
...
assertThat(block1.getLines()).containsExactly("Lorem ipsum dolor sit amet, consectetur adipiscing elit.");
...
map1.put("docdatetime", "2018-01-27 23:06:58 CET");
map1.put("docdir", "");
map1.put("doctime", "23:06:58 CET");
...
map1.put("localdatetime", "2018-01-27 23:06:58 CET");
map1.put("localtime", "23:06:58 CET");
...
when(mockBlock1.getLines()).thenReturn(Collections.singletonList("Lorem ipsum dolor sit amet, consectetur adipiscing elit."));
