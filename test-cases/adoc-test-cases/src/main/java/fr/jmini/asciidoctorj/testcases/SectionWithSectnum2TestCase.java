...
public class SectionWithSectnum2TestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div class=\"sect1\">\n" +
            "<h2 id=\"_first_section\">1. First Section</h2>\n" +
            "<div class=\"sectionbody\">\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 1.</p>\n" +
            "</div>\n" +
            "<div class=\"sect2\">\n" +
            "<h3 id=\"_subsection_a\">1.1. Subsection A</h3>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 2.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            "<div class=\"sect2\">\n" +
            "<h3 id=\"_subsection_b\">1.2. Subsection B</h3>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 3.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            "<div class=\"sect2\">\n" +
            "<h3 id=\"_subsection_c\">1.3. Subsection C</h3>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 4.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            ...
            "</div>\n" +
            "<div class=\"sect1\">\n" +
            "<h2 id=\"_second_section\">2. Second Section</h2>\n" +
            "<div class=\"sectionbody\">\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 5.</p>\n" +
            "</div>\n" +
            "<div class=\"sect2\">\n" +
            "<h3 id=\"_subsection_a_2\">2.1. Subsection a</h3>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 6.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            "<div class=\"sect2\">\n" +
            "<h3 id=\"_subsection_b_2\">2.2. Subsection b</h3>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>Some text for 7.</p>\n" +
            "</div>\n" +
            "</div>\n" +
    ...
    public void checkAst(Document astDocument) {
        ...
        assertThat(document1.getAttributes()).containsEntry("appendix-caption", "Appendix")
                ...
                .containsEntry("docdate", "2018-01-27")
                .containsEntry("docdatetime", "2018-01-27 23:07:56 CET")
                .containsEntry("docdir", "")
                .containsEntry("doctime", "23:07:56 CET")
                .containsEntry("doctype", "article")
                .containsEntry("doctype-article", "")
                .containsEntry("docyear", "2018")
                ...
                .containsEntry("localdate", "2018-01-27")
                .containsEntry("localdatetime", "2018-01-27 23:07:56 CET")
                .containsEntry("localtime", "23:07:56 CET")
                .containsEntry("localyear", "2018")
                .containsEntry("manname-title", "NAME")
                .containsEntry("max-attribute-value-size", 4096L)
                .containsEntry("max-include-depth", 64L)
                .containsEntry("note-caption", "Note")
                .containsEntry("notitle", "")
                .containsEntry("outfilesuffix", ".html")
                .containsEntry("prewrap", "")
                .containsEntry("safe-mode-level", 20L)
        ...
        Section section2 = (Section) section1.getBlocks()
                .get(1);
        assertThat(section2.getId()).isEqualTo("_subsection_a");
        ...
        assertThat(section2.getTitle()).isEqualTo("Subsection A");
        ...
        assertThat(section2.isNumbered()).isTrue();
        Section section3 = (Section) section1.getBlocks()
                .get(2);
        assertThat(section3.getId()).isEqualTo("_subsection_b");
        ...
        assertThat(section3.getTitle()).isEqualTo("Subsection B");
        ...
        assertThat(section4.getTitle()).isEqualTo("Subsection C");
        ...
        Section section5 = (Section) document1.getBlocks()
                .get(1);
        assertThat(section5.getId()).isEqualTo("_second_section");
        assertThat(section5.getNodeName()).isEqualTo("section");
        assertThat(section5.getParent()).isSameAs(document1);
        ...
        assertThat(section5.getTitle()).isEqualTo("Second Section");
        assertThat(section5.getStyle()).isNull();
        assertThat(section5.getLevel()).isEqualTo(1);
        ...
        assertThat(section5.getBlocks()).hasSize(3);
        ...
        assertThat(block5.getLevel()).isEqualTo(1);
        ...
        Section section6 = (Section) section5.getBlocks()
                .get(1);
        assertThat(section6.getId()).isEqualTo("_subsection_a_2");
        assertThat(section6.getNodeName()).isEqualTo("section");
        assertThat(section6.getParent()).isSameAs(section5);
        assertThat(section6.getContext()).isEqualTo("section");
        assertThat(section6.getDocument()).isSameAs(document1);
        assertThat(section6.isInline()).isFalse();
        assertThat(section6.isBlock()).isTrue();
        assertThat(section6.getAttributes()).isNullOrEmpty();
        assertThat(section6.getRoles()).isNullOrEmpty();
        assertThat(section6.isReftext()).isFalse();
        assertThat(section6.getReftext()).isNull();
        assertThat(section6.getCaption()).isNull();
        assertThat(section6.getTitle()).isEqualTo("Subsection a");
        assertThat(section6.getStyle()).isNull();
        assertThat(section6.getLevel()).isEqualTo(2);
        assertThat(section6.getContentModel()).isEqualTo("compound");
        assertThat(section6.getSourceLocation()).isNull();
        assertThat(section6.getSubstitutions()).isNullOrEmpty();
        assertThat(section6.getBlocks()).hasSize(1);
        Block block6 = (Block) section6.getBlocks()
                .get(0);
        assertThat(block6.getId()).isNull();
        assertThat(block6.getNodeName()).isEqualTo("paragraph");
        assertThat(block6.getParent()).isSameAs(section6);
        assertThat(block6.getContext()).isEqualTo("paragraph");
        assertThat(block6.getDocument()).isSameAs(document1);
        assertThat(block6.isInline()).isFalse();
        assertThat(block6.isBlock()).isTrue();
        assertThat(block6.getAttributes()).isNullOrEmpty();
        ...
        assertThat(block6.getLevel()).isEqualTo(2);
        assertThat(block6.getContentModel()).isEqualTo("simple");
        assertThat(block6.getSourceLocation()).isNull();
        assertThat(block6.getSubstitutions()).containsExactly("specialcharacters", "quotes", "attributes", "replacements", "macros", "post_replacements");
        assertThat(block6.getBlocks()).isNullOrEmpty();
        assertThat(block6.getLines()).containsExactly("Some text for 6.");
        assertThat(block6.getSource()).isEqualTo("Some text for 6.");
        assertThat(section6.getIndex()).isEqualTo(0);
        assertThat(section6.getNumber()).isEqualTo(1);
        assertThat(section6.getSectionName()).isEqualTo("section");
        assertThat(section6.isSpecial()).isFalse();
        assertThat(section6.isNumbered()).isTrue();
        Section section7 = (Section) section5.getBlocks()
                .get(2);
        assertThat(section7.getId()).isEqualTo("_subsection_b_2");
        assertThat(section7.getNodeName()).isEqualTo("section");
        assertThat(section7.getParent()).isSameAs(section5);
        assertThat(section7.getContext()).isEqualTo("section");
        assertThat(section7.getDocument()).isSameAs(document1);
        assertThat(section7.isInline()).isFalse();
        assertThat(section7.isBlock()).isTrue();
        assertThat(section7.getAttributes()).isNullOrEmpty();
        assertThat(section7.getRoles()).isNullOrEmpty();
        assertThat(section7.isReftext()).isFalse();
        assertThat(section7.getReftext()).isNull();
        assertThat(section7.getCaption()).isNull();
        assertThat(section7.getTitle()).isEqualTo("Subsection b");
        assertThat(section7.getStyle()).isNull();
        assertThat(section7.getLevel()).isEqualTo(2);
        assertThat(section7.getContentModel()).isEqualTo("compound");
        assertThat(section7.getSourceLocation()).isNull();
        assertThat(section7.getSubstitutions()).isNullOrEmpty();
        assertThat(section7.getBlocks()).hasSize(1);
        Block block7 = (Block) section7.getBlocks()
                .get(0);
        assertThat(block7.getId()).isNull();
        assertThat(block7.getNodeName()).isEqualTo("paragraph");
        assertThat(block7.getParent()).isSameAs(section7);
        assertThat(block7.getContext()).isEqualTo("paragraph");
        assertThat(block7.getDocument()).isSameAs(document1);
        assertThat(block7.isInline()).isFalse();
        assertThat(block7.isBlock()).isTrue();
        assertThat(block7.getAttributes()).isNullOrEmpty();
        ...
        assertThat(block7.getLevel()).isEqualTo(2);
        assertThat(block7.getContentModel()).isEqualTo("simple");
        assertThat(block7.getSourceLocation()).isNull();
        assertThat(block7.getSubstitutions()).containsExactly("specialcharacters", "quotes", "attributes", "replacements", "macros", "post_replacements");
        assertThat(block7.getBlocks()).isNullOrEmpty();
        assertThat(block7.getLines()).containsExactly("Some text for 7.");
        assertThat(block7.getSource()).isEqualTo("Some text for 7.");
        assertThat(section7.getIndex()).isEqualTo(1);
        assertThat(section7.getNumber()).isEqualTo(2);
        assertThat(section7.getSectionName()).isEqualTo("section");
        assertThat(section7.isSpecial()).isFalse();
        assertThat(section7.isNumbered()).isTrue();
        assertThat(section5.getIndex()).isEqualTo(1);
        assertThat(section5.getNumber()).isEqualTo(2);
        assertThat(section5.getSectionName()).isEqualTo("section");
        assertThat(section5.isSpecial()).isFalse();
        assertThat(section5.isNumbered()).isTrue();
    ...
    public Document createMock() {
        ...
        map1.put("docdatetime", "2018-01-27 23:07:56 CET");
        map1.put("docdir", "");
        map1.put("doctime", "23:07:56 CET");
        ...
        map1.put("localdatetime", "2018-01-27 23:07:56 CET");
        map1.put("localtime", "23:07:56 CET");
        ...
        when(mockSection2.getId()).thenReturn("_subsection_a");
        ...
        when(mockSection2.getTitle()).thenReturn("Subsection A");
        ...
        when(mockSection2.isNumbered()).thenReturn(true);
        Section mockSection3 = mock(Section.class);
        when(mockSection3.getId()).thenReturn("_subsection_b");
        ...
        when(mockSection3.getTitle()).thenReturn("Subsection B");
        ...
        when(mockSection4.getTitle()).thenReturn("Subsection C");
        ...
        when(mockSection5.getId()).thenReturn("_second_section");
        when(mockSection5.getNodeName()).thenReturn("section");
        when(mockSection5.getParent()).thenReturn(mockDocument1);
        ...
        when(mockSection5.getTitle()).thenReturn("Second Section");
        when(mockSection5.getStyle()).thenReturn(null);
        when(mockSection5.getLevel()).thenReturn(1);
        ...
        when(mockBlock5.getLevel()).thenReturn(1);
        ...
        Section mockSection6 = mock(Section.class);
        when(mockSection6.getId()).thenReturn("_subsection_a_2");
        when(mockSection6.getNodeName()).thenReturn("section");
        when(mockSection6.getParent()).thenReturn(mockSection5);
        when(mockSection6.getContext()).thenReturn("section");
        when(mockSection6.getDocument()).thenReturn(mockDocument1);
        when(mockSection6.isInline()).thenReturn(false);
        when(mockSection6.isBlock()).thenReturn(true);
        when(mockSection6.getAttributes()).thenReturn(Collections.emptyMap());
        when(mockSection6.getRoles()).thenReturn(Collections.emptyList());
        when(mockSection6.isReftext()).thenReturn(false);
        when(mockSection6.getReftext()).thenReturn(null);
        when(mockSection6.getCaption()).thenReturn(null);
        when(mockSection6.getTitle()).thenReturn("Subsection a");
        when(mockSection6.getStyle()).thenReturn(null);
        when(mockSection6.getLevel()).thenReturn(2);
        when(mockSection6.getContentModel()).thenReturn("compound");
        when(mockSection6.getSourceLocation()).thenReturn(null);
        when(mockSection6.getSubstitutions()).thenReturn(Collections.emptyList());
        Block mockBlock6 = mock(Block.class);
        when(mockBlock6.getId()).thenReturn(null);
        when(mockBlock6.getNodeName()).thenReturn("paragraph");
        when(mockBlock6.getParent()).thenReturn(mockSection6);
        when(mockBlock6.getContext()).thenReturn("paragraph");
        ...
        when(mockBlock6.getAttributes()).thenReturn(Collections.emptyMap());
        ...
        when(mockBlock6.getLevel()).thenReturn(2);
        when(mockBlock6.getContentModel()).thenReturn("simple");
        when(mockBlock6.getSourceLocation()).thenReturn(null);
        when(mockBlock6.getSubstitutions()).thenReturn(Arrays.asList("specialcharacters", "quotes", "attributes", "replacements", "macros", "post_replacements"));
        when(mockBlock6.getBlocks()).thenReturn(Collections.emptyList());
        when(mockBlock6.getLines()).thenReturn(Collections.singletonList("Some text for 6."));
        when(mockBlock6.getSource()).thenReturn("Some text for 6.");
        when(mockSection6.getBlocks()).thenReturn(Collections.singletonList(mockBlock6));
        when(mockSection6.getIndex()).thenReturn(0);
        when(mockSection6.getNumber()).thenReturn(1);
        when(mockSection6.getSectionName()).thenReturn("section");
        when(mockSection6.isSpecial()).thenReturn(false);
        when(mockSection6.isNumbered()).thenReturn(true);
        Section mockSection7 = mock(Section.class);
        when(mockSection7.getId()).thenReturn("_subsection_b_2");
        when(mockSection7.getNodeName()).thenReturn("section");
        when(mockSection7.getParent()).thenReturn(mockSection5);
        when(mockSection7.getContext()).thenReturn("section");
        when(mockSection7.getDocument()).thenReturn(mockDocument1);
        when(mockSection7.isInline()).thenReturn(false);
        when(mockSection7.isBlock()).thenReturn(true);
        when(mockSection7.getAttributes()).thenReturn(Collections.emptyMap());
        when(mockSection7.getRoles()).thenReturn(Collections.emptyList());
        when(mockSection7.isReftext()).thenReturn(false);
        when(mockSection7.getReftext()).thenReturn(null);
        when(mockSection7.getCaption()).thenReturn(null);
        when(mockSection7.getTitle()).thenReturn("Subsection b");
        when(mockSection7.getStyle()).thenReturn(null);
        when(mockSection7.getLevel()).thenReturn(2);
        when(mockSection7.getContentModel()).thenReturn("compound");
        when(mockSection7.getSourceLocation()).thenReturn(null);
        when(mockSection7.getSubstitutions()).thenReturn(Collections.emptyList());
        Block mockBlock7 = mock(Block.class);
        when(mockBlock7.getId()).thenReturn(null);
        when(mockBlock7.getNodeName()).thenReturn("paragraph");
        when(mockBlock7.getParent()).thenReturn(mockSection7);
        when(mockBlock7.getContext()).thenReturn("paragraph");
        ...
        when(mockBlock7.getAttributes()).thenReturn(Collections.emptyMap());
        ...
        when(mockBlock7.getLevel()).thenReturn(2);
        when(mockBlock7.getContentModel()).thenReturn("simple");
        when(mockBlock7.getSourceLocation()).thenReturn(null);
        when(mockBlock7.getSubstitutions()).thenReturn(Arrays.asList("specialcharacters", "quotes", "attributes", "replacements", "macros", "post_replacements"));
        when(mockBlock7.getBlocks()).thenReturn(Collections.emptyList());
        when(mockBlock7.getLines()).thenReturn(Collections.singletonList("Some text for 7."));
        when(mockBlock7.getSource()).thenReturn("Some text for 7.");
        when(mockSection7.getBlocks()).thenReturn(Collections.singletonList(mockBlock7));
        when(mockSection7.getIndex()).thenReturn(1);
        when(mockSection7.getNumber()).thenReturn(2);
        when(mockSection7.getSectionName()).thenReturn("section");
        when(mockSection7.isSpecial()).thenReturn(false);
        when(mockSection7.isNumbered()).thenReturn(true);
        when(mockSection5.getBlocks()).thenReturn(Arrays.asList(mockBlock5, mockSection6, mockSection7));
        when(mockSection5.getIndex()).thenReturn(1);
        when(mockSection5.getNumber()).thenReturn(2);
        when(mockSection5.getSectionName()).thenReturn("section");
        when(mockSection5.isSpecial()).thenReturn(false);
        when(mockSection5.isNumbered()).thenReturn(true);
        when(mockDocument1.getBlocks()).thenReturn(Arrays.asList(mockSection1, mockSection5));
