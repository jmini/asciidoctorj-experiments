...
public class OpenBlockWithCaptionTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("style", "open").containsEntry("title", "Lorem ipsum");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isNull();
assertThat(block1.getTitle()).isEqualTo("Lorem ipsum");
...
map1.put("docdatetime", "2018-01-27 23:07:49 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:49 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:49 CET");
map1.put("localtime", "23:07:49 CET");
