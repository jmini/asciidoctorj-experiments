...
public class ListOlLowerromanTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "lowerroman").containsEntry("start", "5").containsEntry("style", "lowerroman");
...
assertThat(list1.getStyle()).isEqualTo("lowerroman");
...
assertThat(listItem1.getText()).isEqualTo("Five");
assertThat(listItem1.getSource()).isEqualTo("Five");
...
assertThat(listItem2.getText()).isEqualTo("Six");
assertThat(listItem2.getSource()).isEqualTo("Six");
...
assertThat(listItem3.getText()).isEqualTo("Seven");
assertThat(listItem3.getSource()).isEqualTo("Seven");
...
map1.put("docdatetime", "2018-01-27 23:07:30 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:30 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:30 CET");
map1.put("localtime", "23:07:30 CET");
...
map2.put("1", "lowerroman");
map2.put("start", "5");
map2.put("style", "lowerroman");
...
when(mockList1.getStyle()).thenReturn("lowerroman");
...
when(mockListItem1.getText()).thenReturn("Five");
when(mockListItem1.getSource()).thenReturn("Five");
...
when(mockListItem2.getText()).thenReturn("Six");
when(mockListItem2.getSource()).thenReturn("Six");
...
when(mockListItem3.getText()).thenReturn("Seven");
when(mockListItem3.getSource()).thenReturn("Seven");
