...
public class ListOlLowergreekTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "lowergreek").containsEntry("style", "lowergreek");
...
assertThat(list1.getStyle()).isEqualTo("lowergreek");
...
map1.put("docdatetime", "2018-01-27 23:07:29 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:29 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:29 CET");
map1.put("localtime", "23:07:29 CET");
...
map2.put("1", "lowergreek");
map2.put("style", "lowergreek");
...
when(mockList1.getStyle()).thenReturn("lowergreek");
