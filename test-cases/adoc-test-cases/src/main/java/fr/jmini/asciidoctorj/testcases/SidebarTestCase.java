...
public class SidebarTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "</div>\n" +
            "<div class=\"paragraph\">\n" +
            "<p>AsciiDoc was first released in Nov 2002 by Stuart Rackham. It was designed from the start to be a shorthand syntax for producing professional documents like DocBook and LaTeX.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            "</div>";
    // end::expected-html[]
...
assertThat(block1.getAttributes()).containsEntry("style", "sidebar").containsEntry("title", "AsciiDoc history");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isNull();
assertThat(block1.getTitle()).isEqualTo("AsciiDoc history");
...
assertThat(block2.getLines()).containsExactly("AsciiDoc was first released in Nov 2002 by Stuart Rackham.", "It was designed from the start to be a shorthand syntax", "for producing professional documents like DocBook and LaTeX.");
assertThat(block2.getSource()).isEqualTo("AsciiDoc was first released in Nov 2002 by Stuart Rackham.\n" +
"It was designed from the start to be a shorthand syntax\n" +
"for producing professional documents like DocBook and LaTeX.");
...
map1.put("docdatetime", "2018-01-27 23:08:05 CET");
map1.put("docdir", "");
map1.put("doctime", "23:08:05 CET");
...
map1.put("localdatetime", "2018-01-27 23:08:05 CET");
map1.put("localtime", "23:08:05 CET");
...
when(mockBlock2.getLines()).thenReturn(Arrays.asList("AsciiDoc was first released in Nov 2002 by Stuart Rackham.", "It was designed from the start to be a shorthand syntax", "for producing professional documents like DocBook and LaTeX."));
when(mockBlock2.getSource()).thenReturn("AsciiDoc was first released in Nov 2002 by Stuart Rackham.\n" +
"It was designed from the start to be a shorthand syntax\n" +
"for producing professional documents like DocBook and LaTeX.");
