...
public class SidebarTestCase implements AdocTestCase {
    ...
    public void checkAst(Document astDocument) {
        ...
        assertThat(block1.getAttributes()).containsEntry("style", "sidebar")
                .containsEntry("title", "AsciiDoc history");
    ...
    public Document createMock() {
        ...
        when(mockBlock2.getLines()).thenReturn(Arrays.asList("AsciiDoc was first released in Nov 2002 by Stuart Rackham.", "It was designed from the start to be a shorthand syntax",
                "for producing professional documents like DocBook and LaTeX."));
