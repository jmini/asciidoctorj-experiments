...
public class AdmonitionBlockImportantTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "<ol class=\"arabic\">\n" +
            "<li> <p>They are allergic to cinnamon.</p> </li>\n" +
            "<li> <p>More than two glasses of orange juice in 24 hours makes them howl in harmony with alarms and sirens.</p> </li>\n" +
            "<li> <p>Celery makes them sad.</p> </li>\n" +
            "</ol>\n" +
            "</div> </td>\n" +
            "</tr>\n" +
            "</tbody>\n" +
...
assertThat(block1.getAttributes()).containsEntry("1", "IMPORTANT").containsEntry("name", "important").containsEntry("style", "IMPORTANT").containsEntry("textlabel", "Important").containsEntry("title", "Feeding the Werewolves");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isEqualTo("Important");
assertThat(block1.getTitle()).isEqualTo("Feeding the Werewolves");
assertThat(block1.getStyle()).isEqualTo("IMPORTANT");
...
assertThat(block2.getLines()).containsExactly("While werewolves are hardy community members, keep in mind the following dietary concerns:");
assertThat(block2.getSource()).isEqualTo("While werewolves are hardy community members, keep in mind the following dietary concerns:");
...
assertThat(listItem1.getText()).isEqualTo("They are allergic to cinnamon.");
assertThat(listItem1.getSource()).isEqualTo("They are allergic to cinnamon.");
...
assertThat(listItem2.getText()).isEqualTo("More than two glasses of orange juice in 24 hours makes them howl in harmony with alarms and sirens.");
assertThat(listItem2.getSource()).isEqualTo("More than two glasses of orange juice in 24 hours makes them howl in harmony with alarms and sirens.");
...
assertThat(listItem3.getText()).isEqualTo("Celery makes them sad.");
assertThat(listItem3.getSource()).isEqualTo("Celery makes them sad.");
...
map1.put("docdatetime", "2018-01-27 23:06:51 CET");
map1.put("docdir", "");
map1.put("doctime", "23:06:51 CET");
...
map1.put("localdatetime", "2018-01-27 23:06:51 CET");
map1.put("localtime", "23:06:51 CET");
...
map2.put("1", "IMPORTANT");
map2.put("name", "important");
map2.put("style", "IMPORTANT");
map2.put("textlabel", "Important");
map2.put("title", "Feeding the Werewolves");
when(mockBlock1.getAttributes()).thenReturn(map2);
when(mockBlock1.getRoles()).thenReturn(Collections.emptyList());
when(mockBlock1.isReftext()).thenReturn(false);
when(mockBlock1.getReftext()).thenReturn(null);
when(mockBlock1.getCaption()).thenReturn("Important");
when(mockBlock1.getTitle()).thenReturn("Feeding the Werewolves");
when(mockBlock1.getStyle()).thenReturn("IMPORTANT");
...
when(mockBlock2.getLines()).thenReturn(Collections.singletonList("While werewolves are hardy community members, keep in mind the following dietary concerns:"));
when(mockBlock2.getSource()).thenReturn("While werewolves are hardy community members, keep in mind the following dietary concerns:");
...
when(mockListItem1.getText()).thenReturn("They are allergic to cinnamon.");
when(mockListItem1.getSource()).thenReturn("They are allergic to cinnamon.");
...
when(mockListItem2.getText()).thenReturn("More than two glasses of orange juice in 24 hours makes them howl in harmony with alarms and sirens.");
when(mockListItem2.getSource()).thenReturn("More than two glasses of orange juice in 24 hours makes them howl in harmony with alarms and sirens.");
...
when(mockListItem3.getText()).thenReturn("Celery makes them sad.");
when(mockListItem3.getSource()).thenReturn("Celery makes them sad.");
