...
public class AdmonitionBlockImportantTestCase implements AdocTestCase {
    ...
    public void checkAst(Document astDocument) {
        ...
        assertThat(block1.getAttributes()).containsEntry("1", "IMPORTANT")
                .containsEntry("name", "important")
                .containsEntry("style", "IMPORTANT")
                .containsEntry("textlabel", "Important")
                .containsEntry("title", "Feeding the Werewolves");
