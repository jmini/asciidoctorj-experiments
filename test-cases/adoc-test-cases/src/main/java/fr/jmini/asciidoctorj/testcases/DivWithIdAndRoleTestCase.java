...
public class DivWithIdAndRoleTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"idname\" class=\"paragraph rolename\">\n" +
            "<p>This text</p>\n" +
            "</div>";
    // end::expected-html[]
...
assertThat(block1.getAttributes()).containsEntry("1", "#idname.rolename").containsEntry("id", "idname").containsEntry("role", "rolename");
...
map1.put("docdatetime", "2018-01-27 23:07:03 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:03 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:03 CET");
map1.put("localtime", "23:07:03 CET");
