...
public class ListLabeledWithIdAndRoleTestCase implements AdocTestCase {
...
DescriptionList descriptionList1 = (DescriptionList) document1.getBlocks().get(0);
...
assertThat(descriptionList1.getAttributes()).containsEntry("1", "#idd.rolee").containsEntry("id", "idd").containsEntry("role", "rolee");
...
DescriptionListEntry descriptionListEntry1 = (DescriptionListEntry) descriptionList1.getItems().get(0);
...
ListItem listItem2 = (ListItem) descriptionListEntry1.getTerms().get(0);
...
DescriptionListEntry descriptionListEntry2 = (DescriptionListEntry) descriptionList1.getItems().get(1);
...
ListItem listItem4 = (ListItem) descriptionListEntry2.getTerms().get(0);
...
DescriptionListEntry descriptionListEntry3 = (DescriptionListEntry) descriptionList1.getItems().get(2);
...
ListItem listItem6 = (ListItem) descriptionListEntry3.getTerms().get(0);
...
map1.put("docdatetime", "2018-01-27 23:07:24 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:24 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:24 CET");
map1.put("localtime", "23:07:24 CET");
