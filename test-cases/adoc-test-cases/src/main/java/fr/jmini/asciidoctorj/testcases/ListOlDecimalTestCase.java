...
public class ListOlDecimalTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "decimal").containsEntry("style", "decimal");
...
assertThat(list1.getStyle()).isEqualTo("decimal");
...
map1.put("docdatetime", "2018-01-27 23:07:26 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:26 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:26 CET");
map1.put("localtime", "23:07:26 CET");
...
when(mockList1.getStyle()).thenReturn("decimal");
