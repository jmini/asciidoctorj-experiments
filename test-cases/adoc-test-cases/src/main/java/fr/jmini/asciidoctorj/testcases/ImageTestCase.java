...
public class ImageTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"di\" class=\"imageblock elor\">\n" +
            "<div class=\"content\">\n" +
...
assertThat(block1.getAttributes()).containsEntry("1", "#di.elor").containsEntry("alt", "sunset").containsEntry("default-alt", "sunset").containsEntry("id", "di").containsEntry("role", "elor").containsEntry("target", "http://asciidoctor.org/images/sunset.jpg");
...
map1.put("docdatetime", "2018-01-27 23:07:21 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:21 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:21 CET");
map1.put("localtime", "23:07:21 CET");
