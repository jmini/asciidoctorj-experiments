...
public class ListOlLoweralphaTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "loweralpha").containsEntry("style", "loweralpha");
...
assertThat(list1.getStyle()).isEqualTo("loweralpha");
...
map1.put("docdatetime", "2018-01-27 23:07:27 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:27 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:27 CET");
map1.put("localtime", "23:07:27 CET");
...
map2.put("1", "loweralpha");
map2.put("style", "loweralpha");
...
when(mockList1.getStyle()).thenReturn("loweralpha");
