...
public class OpenBlockSidebarTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("1", "sidebar").containsEntry("style", "sidebar").containsEntry("title", "Related information");
assertThat(block1.getRoles()).isNullOrEmpty();
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isNull();
assertThat(block1.getTitle()).isEqualTo("Related information");
...
assertThat(block2.getLines()).containsExactly("This is aside text.");
assertThat(block2.getSource()).isEqualTo("This is aside text.");
...
assertThat(block3.getLines()).containsExactly("It is used to present information related to the main content.");
assertThat(block3.getSource()).isEqualTo("It is used to present information related to the main content.");
...
map1.put("docdatetime", "2018-01-27 23:07:47 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:47 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:47 CET");
map1.put("localtime", "23:07:47 CET");
...
when(mockBlock2.getLines()).thenReturn(Collections.singletonList("This is aside text."));
when(mockBlock2.getSource()).thenReturn("This is aside text.");
...
when(mockBlock3.getLines()).thenReturn(Collections.singletonList("It is used to present information related to the main content."));
when(mockBlock3.getSource()).thenReturn("It is used to present information related to the main content.");
