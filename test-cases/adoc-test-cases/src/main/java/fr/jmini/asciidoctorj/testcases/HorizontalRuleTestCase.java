...
public class HorizontalRuleTestCase implements AdocTestCase {
...
map1.put("docdatetime", "2018-01-27 23:07:13 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:13 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:13 CET");
map1.put("localtime", "23:07:13 CET");
...
when(mockBlock1.getNodeName()).thenReturn("thematic_break");
when(mockBlock1.getParent()).thenReturn(mockDocument1);
when(mockBlock1.getContext()).thenReturn("thematic_break");
