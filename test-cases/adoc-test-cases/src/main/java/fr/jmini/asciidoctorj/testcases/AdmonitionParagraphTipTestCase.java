...
public class AdmonitionParagraphTipTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "Tip\n" +
            "</div> </td>\n" +
            "<td class=\"content\"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec aliquam tempus quam et sollicitudin. Integer sollicitudin nisl et quam scelerisque molestie. </td>\n" +
            "</tr>\n" +
            "</tbody>\n" +
            "</table>\n" +
            "</div>";
...
assertThat(block1.getAttributes()).containsEntry("name", "tip").containsEntry("style", "TIP").containsEntry("textlabel", "Tip");
...
assertThat(block1.getLines()).containsExactly("Lorem ipsum dolor sit amet, consectetur adipiscing elit.", "Donec aliquam tempus quam et sollicitudin.", "Integer sollicitudin nisl et quam scelerisque molestie.");
...
map1.put("docdatetime", "2018-01-27 23:06:59 CET");
map1.put("docdir", "");
map1.put("doctime", "23:06:59 CET");
...
map1.put("localdatetime", "2018-01-27 23:06:59 CET");
map1.put("localtime", "23:06:59 CET");
...
when(mockBlock1.getLines()).thenReturn(Arrays.asList("Lorem ipsum dolor sit amet, consectetur adipiscing elit.", "Donec aliquam tempus quam et sollicitudin.", "Integer sollicitudin nisl et quam scelerisque molestie."));
