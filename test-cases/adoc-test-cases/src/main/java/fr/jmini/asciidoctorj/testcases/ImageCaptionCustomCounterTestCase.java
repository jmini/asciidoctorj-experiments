...
assertThat(block1.getAttributes()).containsEntry("1", ".right.text-center").containsEntry("alt", "sunset").containsEntry("default-alt", "sunset").containsEntry("role", "right text-center").containsEntry("target", "sunset.jpg");
...
assertThat(block2.getAttributes()).containsEntry("1", "Tux").containsEntry("2", "250").containsEntry("3", "350").containsEntry("alt", "Tux").containsEntry("height", "350").containsEntry("target", "http://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg").containsEntry("width", "250");
...
map1.put("docdatetime", "2018-01-27 23:07:14 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:14 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:14 CET");
map1.put("localtime", "23:07:14 CET");
