...
public class ListUlTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "#iid.rrole").containsEntry("id", "iid").containsEntry("role", "rrole");
...
map1.put("docdatetime", "2018-01-27 23:07:34 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:34 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:34 CET");
map1.put("localtime", "23:07:34 CET");
...
when(mockListItem3.getText()).thenReturn("This is line three.\n" +
"With more content");
when(mockListItem3.getSource()).thenReturn("This is line three.\n" +
"With more content");
