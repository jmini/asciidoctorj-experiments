...
public class AdmonitionBlockCautionTestCase implements AdocTestCase {
...
assertThat(block1.getAttributes()).containsEntry("1", "CAUTION").containsEntry("name", "caution").containsEntry("style", "CAUTION").containsEntry("textlabel", "Caution").containsEntry("title", "lorem ipsum dolor sit amet");
...
map1.put("docdatetime", "2018-01-27 23:06:49 CET");
map1.put("docdir", "");
map1.put("doctime", "23:06:49 CET");
...
map1.put("localdatetime", "2018-01-27 23:06:49 CET");
map1.put("localtime", "23:06:49 CET");
