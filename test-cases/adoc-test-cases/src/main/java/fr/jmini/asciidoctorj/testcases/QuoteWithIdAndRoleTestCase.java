...
public class QuoteWithIdAndRoleTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"idd\" class=\"quoteblock rolee\">\n" +
            "<div class=\"title\">\n" +
            "some caption\n" +
            "</div>\n" +
            "<blockquote>\n" +
...
assertThat(block1.getAttributes()).containsEntry("1", "#idd.rolee").containsEntry("id", "idd").containsEntry("role", "rolee").containsEntry("style", "quote").containsEntry("title", "some caption");
assertThat(block1.getRoles()).containsExactly("rolee");
assertThat(block1.isReftext()).isFalse();
assertThat(block1.getReftext()).isNull();
assertThat(block1.getCaption()).isNull();
assertThat(block1.getTitle()).isEqualTo("some caption");
...
org.asciidoctor.ast.List list1 = (org.asciidoctor.ast.List) block1.getBlocks().get(0);
...
assertThat(listItem1.getText()).isEqualTo("one.");
assertThat(listItem1.getSource()).isEqualTo("one.");
...
assertThat(listItem2.getText()).isEqualTo("two.");
assertThat(listItem2.getSource()).isEqualTo("two.");
...
assertThat(listItem3.getText()).isEqualTo("three.");
assertThat(listItem3.getSource()).isEqualTo("three.");
...
map1.put("docdatetime", "2018-01-27 23:07:51 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:51 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:51 CET");
map1.put("localtime", "23:07:51 CET");
