...
assertThat(block1.getAttributes()).containsEntry("1", "Sunset").containsEntry("2", "300").containsEntry("3", "200").containsEntry("alt", "Sunset").containsEntry("height", "200").containsEntry("id", "img-sunset").containsEntry("link", "http://www.flickr.com/photos/javh/5448336655").containsEntry("target", "sunset.jpg").containsEntry("width", "300");
...
assertThat(block2.getAttributes()).containsEntry("alt", "sunset2").containsEntry("default-alt", "sunset2").containsEntry("target", "sunset2.jpg");
