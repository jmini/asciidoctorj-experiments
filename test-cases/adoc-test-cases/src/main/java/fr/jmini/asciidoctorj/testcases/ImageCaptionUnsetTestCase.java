...
public class ImageCaptionUnsetTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "<div class=\"content\">\n" +
            "<img src=\"sunset1.jpg\" alt=\"sunset1\" />\n" +
            "</div>\n" +
            "<div class=\"title\">\n" +
            "first caption\n" +
            "</div>\n" +
...
assertThat(block1.getAttributes()).containsEntry("alt", "sunset1").containsEntry("default-alt", "sunset1").containsEntry("target", "sunset1.jpg");
...
map2.put("alt", "sunset1");
map2.put("default-alt", "sunset1");
map2.put("target", "sunset1.jpg");
