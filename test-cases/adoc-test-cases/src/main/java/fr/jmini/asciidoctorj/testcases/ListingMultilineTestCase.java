...
public class ListingMultilineTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            "<div id=\"lstsome\" class=\"listingblock\">\n" +
            "<div class=\"title\">\n" +
            "this is a caption\n" +
            "</div>\n" +
            "<div class=\"content\">\n" +
...
assertThat(block1.getId()).isEqualTo("lstsome");
...
assertThat(block1.getAttributes()).containsEntry("id", "lstsome").containsEntry("reftext", "some listing").containsEntry("style", "listing").containsEntry("title", "this is a caption");
...
assertThat(block1.getLines()).containsExactly("Line one", "Line two");
...
map1.put("docdatetime", "2018-01-27 23:07:43 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:43 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:43 CET");
map1.put("localtime", "23:07:43 CET");
...
map2.put("id", "lstsome");
map2.put("reftext", "some listing");
map2.put("style", "listing");
map2.put("title", "this is a caption");
