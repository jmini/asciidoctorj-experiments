...
DescriptionList descriptionList2 = (DescriptionList) listItem1.getBlocks().get(0);
...
DescriptionListEntry descriptionListEntry2 = (DescriptionListEntry) descriptionList2.getItems().get(0);
...
org.asciidoctor.ast.List list1 = (org.asciidoctor.ast.List) listItem2.getBlocks().get(0);
...
ListItem listItem3 = (ListItem) list1.getItems().get(0);
...
org.asciidoctor.ast.List list2 = (org.asciidoctor.ast.List) listItem3.getBlocks().get(0);
...
ListItem listItem4 = (ListItem) list2.getItems().get(0);
...
ListItem listItem5 = (ListItem) list1.getItems().get(1);
...
org.asciidoctor.ast.List list3 = (org.asciidoctor.ast.List) listItem5.getBlocks().get(0);
...
ListItem listItem6 = (ListItem) list3.getItems().get(0);
...
ListItem listItem7 = (ListItem) list3.getItems().get(1);
...
ListItem listItem8 = (ListItem) descriptionListEntry2.getTerms().get(0);
...
DescriptionListEntry descriptionListEntry3 = (DescriptionListEntry) descriptionList2.getItems().get(1);
...
org.asciidoctor.ast.List list4 = (org.asciidoctor.ast.List) listItem9.getBlocks().get(0);
...
ListItem listItem10 = (ListItem) list4.getItems().get(0);
...
ListItem listItem11 = (ListItem) list4.getItems().get(1);
...
ListItem listItem12 = (ListItem) descriptionListEntry3.getTerms().get(0);
...
ListItem listItem13 = (ListItem) descriptionListEntry1.getTerms().get(0);
...
DescriptionListEntry descriptionListEntry4 = (DescriptionListEntry) descriptionList1.getItems().get(1);
...
DescriptionList descriptionList3 = (DescriptionList) listItem14.getBlocks().get(0);
...
DescriptionListEntry descriptionListEntry5 = (DescriptionListEntry) descriptionList3.getItems().get(0);
...
org.asciidoctor.ast.List list5 = (org.asciidoctor.ast.List) listItem15.getBlocks().get(0);
...
ListItem listItem16 = (ListItem) list5.getItems().get(0);
...
ListItem listItem17 = (ListItem) list5.getItems().get(1);
...
ListItem listItem18 = (ListItem) descriptionListEntry5.getTerms().get(0);
...
DescriptionListEntry descriptionListEntry6 = (DescriptionListEntry) descriptionList3.getItems().get(1);
...
org.asciidoctor.ast.List list6 = (org.asciidoctor.ast.List) listItem19.getBlocks().get(0);
...
ListItem listItem20 = (ListItem) list6.getItems().get(0);
...
ListItem listItem21 = (ListItem) list6.getItems().get(1);
...
ListItem listItem22 = (ListItem) descriptionListEntry6.getTerms().get(0);
...
ListItem listItem23 = (ListItem) descriptionListEntry4.getTerms().get(0);
...
map1.put("docdatetime", "2018-01-27 23:07:22 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:22 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:22 CET");
map1.put("localtime", "23:07:22 CET");
