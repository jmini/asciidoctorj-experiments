...
public class OpenBlockTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "<div class=\"content\">\n" +
            "<div class=\"paragraph\">\n" +
            "<p>An open block can be an anonymous container, or it can masquerade as any other block.</p>\n" +
            "</div>\n" +
            "</div>\n" +
            "</div>";
    // end::expected-html[]
...
assertThat(block1.getAttributes()).containsEntry("style", "open");
...
assertThat(block2.getLines()).containsExactly("An open block can be an anonymous container,", "or it can masquerade as any other block.");
assertThat(block2.getSource()).isEqualTo("An open block can be an anonymous container,\n" +
"or it can masquerade as any other block.");
...
map1.put("docdatetime", "2018-01-27 23:07:48 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:48 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:48 CET");
map1.put("localtime", "23:07:48 CET");
...
when(mockBlock2.getLines()).thenReturn(Arrays.asList("An open block can be an anonymous container,", "or it can masquerade as any other block."));
when(mockBlock2.getSource()).thenReturn("An open block can be an anonymous container,\n" +
"or it can masquerade as any other block.");
