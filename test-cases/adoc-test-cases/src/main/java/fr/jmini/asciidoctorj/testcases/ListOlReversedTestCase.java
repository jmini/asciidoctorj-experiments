...
public class ListOlReversedTestCase implements AdocTestCase {
...
assertThat(list1.getAttributes()).containsEntry("1", "%reversed").containsEntry("options", "reversed").containsEntry("reversed-option", "").containsEntry("style", "arabic");
...
assertThat(list1.getTitle()).isEqualTo("Parts of an atom");
...
assertThat(listItem1.getText()).isEqualTo("Protons");
assertThat(listItem1.getSource()).isEqualTo("Protons");
...
assertThat(listItem2.getText()).isEqualTo("Electrons");
assertThat(listItem2.getSource()).isEqualTo("Electrons");
...
assertThat(listItem3.getText()).isEqualTo("Neutrons");
assertThat(listItem3.getSource()).isEqualTo("Neutrons");
...
map1.put("docdatetime", "2018-01-27 23:07:32 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:32 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:32 CET");
map1.put("localtime", "23:07:32 CET");
...
map2.put("1", "%reversed");
map2.put("options", "reversed");
map2.put("reversed-option", "");
...
when(mockList1.getTitle()).thenReturn("Parts of an atom");
...
when(mockListItem1.getText()).thenReturn("Protons");
when(mockListItem1.getSource()).thenReturn("Protons");
...
when(mockListItem2.getText()).thenReturn("Electrons");
when(mockListItem2.getSource()).thenReturn("Electrons");
...
when(mockListItem3.getText()).thenReturn("Neutrons");
when(mockListItem3.getSource()).thenReturn("Neutrons");
