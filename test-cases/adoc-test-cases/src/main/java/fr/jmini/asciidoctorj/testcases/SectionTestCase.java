...
Block block2 = (Block) section1.getBlocks().get(1);
...
Section section2 = (Section) document1.getBlocks().get(1);
...
assertThat(section2.getAttributes()).containsEntry("1", "#someid.somerole").containsEntry("id", "someid").containsEntry("role", "somerole");
...
Block block3 = (Block) section2.getBlocks().get(0);
...
map1.put("docdatetime", "2018-01-27 23:07:54 CET");
map1.put("docdir", "");
map1.put("doctime", "23:07:54 CET");
...
map1.put("localdatetime", "2018-01-27 23:07:54 CET");
map1.put("localtime", "23:07:54 CET");
