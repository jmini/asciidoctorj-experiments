...
public class ShowTitleFalseTestCase implements AdocTestCase {
    ...
    public Map<String, Object> getInputOptions() {
        // AttributesBuilder.attributes().showTitle(false) is not working
        // See https://github.com/asciidoctor/asciidoctorj/issues/616
