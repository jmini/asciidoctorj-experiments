...
public class ListingTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "<div class=\"content\">\n" +
            "<pre class=\"highlight nowrap\"><code>Line one</code></pre>\n" +
            "</div>\n" +
            "</div>";
    // end::expected-html[]
...
assertThat(block1.getAttributes()).containsEntry("1", "source%nowrap").containsEntry("nowrap-option", "").containsEntry("options", "nowrap").containsEntry("style", "source");
...
assertThat(block1.getLines()).containsExactly("Line one");
...
map2.put("1", "source%nowrap");
map2.put("nowrap-option", "");
map2.put("options", "nowrap");
