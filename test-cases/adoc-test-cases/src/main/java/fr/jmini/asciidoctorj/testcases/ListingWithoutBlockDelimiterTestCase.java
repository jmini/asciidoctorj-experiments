...
public class ListingWithoutBlockDelimiterTestCase implements AdocTestCase {
    ...
    public static final String EXPECTED_HTML = "" +
            ...
            "<div class=\"content\">\n" +
            "<pre>sudo dnf install asciidoc</pre>\n" +
            "</div>\n" +
            "</div>";
    // end::expected-html[]
...
assertThat(block1.getLines()).containsExactly("sudo dnf install asciidoc");
assertThat(block1.getSource()).isEqualTo("sudo dnf install asciidoc");
...
when(mockBlock1.getLines()).thenReturn(Collections.singletonList("sudo dnf install asciidoc"));
when(mockBlock1.getSource()).thenReturn("sudo dnf install asciidoc");
